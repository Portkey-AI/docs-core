...
2. Once you get confirmation from Portkey that your Azure account is whitelisted, create Azure Private Endpoint connection to Portkey Control Plane.
  ...
  az network private-endpoint create \
    ...
    --resource-group ${RESOURCE_GROUP} \
    --subnet <SUBNET_ID> \
    --private-connection-resource-id "/subscriptions/4bec865f-23ea-4d04-be20-3e883cbb3eb1/resourceGroups/privatelink/providers/Microsoft.Network/privateLinkServices/portkey-privatelink-pls" \
