...
Before you can create and manage prompts, you'll need to set up your [LLM integrations](/product/integrations). After configuring your keys, the respective AI providers become available for running and managing prompts.
