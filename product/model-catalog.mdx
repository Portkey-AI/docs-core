---
title: "Model Catalog"
description: "A single pane to view and manage every AI provider and model in your organization. It provider centralized governance, discovery, and usage. "
---

The Model Catalog is a centralized hub for viewing and managing all AI providers and models within your organization. Providing a powerful and streamlined way to control your AI resources.
...
<Frame>![Model Catalog - Provider and Models](/providersandmodels.gif)</Frame>
...
<Steps>
  ...
  GO to the [Model Catalog Page](https://app.portkey.ai/model-catalog) on Portkey's Sidebar and head over to the AI Providers Tab
    <Frame>![Portkey Model Catalog - Add Provider](/Screenshot2025-07-21at5.29.57PM.png)</Frame>
  </Step>
  <Step title="Select the AI Service to integrate">
    Choose from list (OpenAI, Anthropic, etc.) or _Self-hosted / Custom_.

    <Frame>![Portkey Model Catalog - Add Provider - Choose Service](/Screenshot2025-07-21at5.31.49PM.png)</Frame>
  </Step>
  <Step title="Enter Credentials">
    Choose existing [LLM Integration](/product/integrations) or create a new.

    <Frame>![Model Catalog - Add credentials](/Screenshot2025-07-21at5.34.13PM.png)</Frame>

    <Note>
    It's important to note here you need an already eisting integration or need to createa a new integration. Learn more here. Intergration is where you securely manage your third party LLM credentials like OpenAI/Azure/AWS Bedrock.
    </Note>
  </Step>
  <Step title="Enter provider details & save">
    ...
    <Frame>![Model Catalog - Add Provider Details](/Screenshot2025-07-21at5.36.14PM.png)</Frame>
  </Step>
</Steps>
...
Portkey's config are simple JSON structures that helps you define your routing logic for any LLM requests you can learn more about them [here](/product/ai-gateway/configs).
POrtkey's config allows you to declare either the provider OR  provider+model cofgiuraiton in your routing config
...
<Tabs>
<Tab title="Model String Composition (Recommended)">
...
<Tab title="Using the `provider` header">
...
<Tab title="Specify `provider` in the config">
### 3. Specify `provider` in the config
