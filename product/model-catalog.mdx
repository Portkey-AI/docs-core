...
<Tip>
  ...
  **Need help?** See our [Migration Guide ➜](#link-to-upgrade-doc)
</Tip>

![Providersandmodels Gi](/images/providersandmodels.gif)
...
<Steps>
  <Step title="Go to AI Providers → Add Provider">
    ![Portkey Model Catalog - Add Provider](/images/Screenshot2025-07-21at5.29.57PM.png)
  </Step>
  <Step title="Select the AI Service to integrate">
    Choose from list (OpenAI, Anthropic, etc.) or _Self-hosted / Custom_.

    ![Portkey Model Catalog - Add Provider - Choose Service](/images/Screenshot2025-07-21at5.31.49PM.png)
  </Step>
  <Step title="Enter Credentials">
    Choose existing credentials or create new ones.

    ![Model Catalog - Add credentials](/Addcree.png)
  </Step>
  <Step title="Enter provider details & save">
    ...
    ![Model Catalog - Add Provider Details](/images/Screenshot2025-07-21at5.36.14PM.png)
  </Step>
</Steps>
...
<img
  src="/images/Screenshot2025-07-21at5.39.59PM.png"
