...
<Frame>
  <img src="/images/providersandmodels.gif" alt="Model Catalog - Provider and Models" />
</Frame>
...
<Steps>
  <Step title="Go to AI Providers → Add Provider">
    ...
    <Frame>
      <img src="/images/product/model-catalog/model-catalog-ai-providers-list-new.png" alt="Portkey Model Catalog - AI Providers list" />
    </Frame>
  </Step>
  <Step title="Select the AI Service">
    ...
    <Frame>
      <img src="/images/product/model-catalog/model-catalog-add-provider-choose-service-v2.png" alt="Portkey Model Catalog - Add Provider - Choose Service" />
    </Frame>
  </Step>
  <Step title="Choose or Create Credentials">
    ...
    **If creating new credentials:**
    ...
    <Frame>
      <img src="/images/product/model-catalog/model-catalog-add-provider-credentials-v2.png" alt="Model Catalog - Add credentials" />
    </Frame>
  </Step>
  <Step title="Name your provider & save">
    ...
    <Frame>
      <img src="/images/product/model-catalog/model-catalog-add-provider-details-v2.png" alt="Model Catalog - Add Provider Details" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/product/model-catalog/model-catalog-integrations-overview-v3.png" alt="Integrations Overview Page" />
</Frame>
...
<Frame>
  <img src="/images/product/model-catalog/model-catalog-budget-limits-configuration-v2.png" alt="Budget Limits Configuration" />
</Frame>
...
<Frame>
  <img src="/images/product/model-catalog/model-catalog-workspace-provisioning-interface-v2.png" alt="Workspace Provisioning Interface" />
</Frame>
...
<Frame>
  <img src="/images/product/model-catalog/model-catalog-model-provisioning-settings-v2.png" alt="Model Provisioning Settings" />
</Frame>
