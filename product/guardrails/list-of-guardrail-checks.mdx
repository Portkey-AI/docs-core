...
<CardGroup cols={3}>
  ...
  <Card
    title="Tavily"
    href="/integrations/plugins/tavily"
  ...
  >
    * Policy-based guardrails for prompts and model responses * Blocks, masks or records content against the policies configured for your application
  </Card>
</CardGroup>
