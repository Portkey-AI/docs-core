...
<CardGroup cols={3}>
  ...
  <Card title="Acuvity" href="/product/guardrails/acuvity">
    <img src="/images/product/Guardrails/acuvity-logo.png" />
    * Scan Prompts
    * Scan Responses

    For PII, toxicity, prompt injection detection, and more.
  </Card>
  <Card title="AWS Bedrock" href="/product/guardrails/bedrock-guardrials">
    <img src="/images/product/Guardrails/bedrock-logo.jpeg" />
