...
<CardGroup cols={3}>
  ...
  <Card title="Acuvity" href="/product/guardrails/acuvity">
    <img src="/images/product/Guardrails/acuvity-logo.jpeg" />
    * Scan Prompts
    * Scan Responses
     For PII, toxicity, prompt injection detection, and more.
  </Card>
  <Card title="AWS Bedrock" href="/product/guardrails/bedrock-guardrails">
    <img src="/images/guardrails/bedrock-logo.png" />
