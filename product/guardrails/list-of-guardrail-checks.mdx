...
<CardGroup cols={3}>
  <Card title="Javelin" href="/integrations/guardrails/javelin" img="/images/product/Guardrails/Javelin.png">
  ...
  <Card title="Qualifire" href="/integrations/guardrails/qualifire" img="/images/product/Guardrails/Qualifire.jpg">
    * Contextual, state-of-the-art SLM guardrails
    * Detect hallucinations, unsafe content, and inconsistencies
    * Prevent out‑of‑scope and unpredictable model behavior
  </Card>
</CardGroup>
