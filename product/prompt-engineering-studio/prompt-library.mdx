...
3. Build your prompt in the Prompt Playground
4. Save the prompt to add it to your library

New prompts are automatically assigned a unique ID that you can use to reference them in your applications.
...
- Changes are tracked by user and timestamp
...
- [Prompt Playground](/product/prompts-new/prompt-playground) - Create and test new prompts
- [Prompt Partials](/product/prompts-new/prompt-partials) - Create reusable prompt components
- [Prompt Versioning](/product/prompts-new/prompt-versioning) - Track changes to your prompts
- [Prompt API](/product/prompts-new/prompt-api) - Integrate prompts into your applications
