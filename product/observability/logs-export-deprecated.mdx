...
<Note>
Portkey offers an in-app logs export feature that is not generally available yet. If you're interested in early access, contact [Portkey support](https://support.portkey.ai/forms/customer-portal-ticket-form).
</Note>
...
2. Submit a request via [Portkey support](https://support.portkey.ai/forms/customer-portal-ticket-form) with the subject line `Logs Export - [Your_Organization_Name]`.
3. In the email body,
