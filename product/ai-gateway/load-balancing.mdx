...
<CardGroup cols={2}>
  <Card title="Load Balancer inside Conditional Routing" icon="code-branch" href="/guides/use-cases/combining-routing-strategies#route-by-model-distribute-by-provider">
  ...
  <Card title="Load Balancer with a Fallback Safety Net" icon="shield" href="/guides/use-cases/combining-routing-strategies#distribute-with-a-fallback-safety-net">
  ...
  <Card title="Per-Leg Fallbacks" icon="layer-group" href="/guides/use-cases/combining-routing-strategies#per-leg-fallbacks-in-a-load-balancer">
    Give each load-balanced slot its own independent fallback. An OpenAI outage only affects that leg — the other models route normally.
  </Card>
