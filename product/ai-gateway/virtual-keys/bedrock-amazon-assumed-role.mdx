...
To enable **Assumed Role for AWS in your Portkey Enterprise deployment**, you can refer to [this guide](https://github.com/Portkey-AI/helm/blob/main/charts/portkey-gateway/docs/Bedrock.md). If you face any issue, please reach out to us at support@portkey.ai. ([Link to our Helm chart docs](https://github.com/Portkey-AI/helm-chart/blob/main/helm/enterprise/README.md#aws-assumed-role-for-bedrock))
</Note>
