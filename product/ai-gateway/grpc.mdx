...
- Gateway service: `src/grpc/gateway.proto`
- Gemini service (native gRPC): `src/providers/google/grpc/gemini.proto`

Generate client stubs for your language using the gateway proto file.
