...
See the [Messages API guide](/product/ai-gateway/messages-api) for more on using the Messages format across providers, and the [Responses API guide](/product/ai-gateway/responses-api) for the Responses API specification.
