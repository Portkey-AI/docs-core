...
<Note>
  ...
  to use the fine-tuned model for inference whereas providers like `Bedrock` abd `Vertex` does
  require you to manually provider compute which is hard for portkey to manage.
</Note>
