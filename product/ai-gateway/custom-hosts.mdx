...
After setting this, requests with `custom_host` set to `http://172.31.2.45:8008/v1/` will pass validation.
...
| **Private network IP** (e.g., `172.31.2.45:8008`) | Blocked -- falls within `172.16.0.0/12` | Add the IP to `TRUSTED_CUSTOM_HOSTS` |
