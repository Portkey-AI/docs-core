...
The following providers are supported for speech-to-text with more providers getting added soon. Please raise a [request](/docs/integrations/llms/suggest-a-new-integration) or a [PR](https://github.com/Portkey-AI/gateway/pulls) to add model or provider to the AI gateway.

| Provider                                 | Models    | Functions                 |
| ---------------------------------------- | --------- | ------------------------- |
| [OpenAI](/docs/integrations/llms/openai) | whisper-1 | Transcription Translation |
