...
| ---------------------------------------------------- | -------------------------------------------------------------------------------------------- | ---------------------- |
| [OpenAI](/integrations/llms/openai)             | `gpt-4-vision-preview`                                                                         | Create Chat Completion |
| [Azure OpenAI](/integrations/llms/azure-openai) | `gpt-4-vision-preview `                                                                        | Create Chat Completion |
| [Gemini](/integrations/llms/gemini)             | `gemini-1.0-pro-vision `                                                                       | Create Chat Completion |
| [Anthropic](/integrations/llms/anthropic)       | `claude-3-sonnet claude-3-haiku claude-3-opus `                                                | Create Chat Completion |
| [AWS Bedrock](/integrations/llms/aws-bedrock)   | `anthropic.claude-3-sonnet anthropic.claude-3-haiku anthropic.claude-3-5-sonnet-20240620-v1:0` | Create Chat Completion |
