...
We are upgrading the Virtual Key experience with the <b>[Model Catalog](/product/model-catalog)</b> feature.
...
<CardGroup cols={2}>
<Card icon="book" title="Upgrade to Model Catalog" href="/support/model-catalog-upgrade">Learn how to replace your virtual keys with Model Catalog</Card>
<Card icon="wrench" title="Integrate new Provider" href="/product/integrations">Learn how to create new AI provider integrations for your Portkey org</Card>
</CardGroup>
