...
<Card title="Budget Limits Guide" icon="dollar-sign" href="/product/ai-gateway/virtual-keys/budget-limits">
...
<Card title="Rate Limits Guide" icon="gauge" href="/product/ai-gateway/virtual-keys/rate-limits">
