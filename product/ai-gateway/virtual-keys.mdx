...
<CardGroup cols={2}>
<Card icon="book" title="Upgrade to Model Catalog" href="/product/model-catalog">Learn how to replace your virtual keys with Model Catalog</Card>
<Card icon="wrench" title="Integrate new Provider" href="/product/ai-gateway/virtual-keys">Learn how to integrate new AI providers with Portkey</Card>
</CardGroup>
