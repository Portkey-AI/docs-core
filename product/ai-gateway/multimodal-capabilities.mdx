...
<Card title="Vision" href="/docs/product/ai-gateway/multimodal-capabilities/vision" />
  ...
  <Card title="Speech-to-Text" href="/docs/product/ai-gateway/multimodal-capabilities/speech-to-text" />

  <Card title="Text-to-Speech" href="/docs/product/ai-gateway/multimodal-capabilities/text-to-speech" />
