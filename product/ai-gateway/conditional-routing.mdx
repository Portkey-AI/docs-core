...
<CardGroup cols={2}>
  <Card title="Conditional → Load Balancer" icon="scale-balanced" href="/guides/use-cases/combining-routing-strategies#route-by-model-distribute-by-provider">
  ...
  <Card title="Conditional → Fallback (per branch)" icon="shield" href="/guides/use-cases/combining-routing-strategies#per-branch-fallbacks-in-a-conditional-router">
  ...
  <Card title="Fallback → Conditional Router" icon="code-branch" href="/guides/use-cases/combining-routing-strategies#fall-back-to-a-conditional-router">
  ...
  <Card title="Load Balancer → Per-Leg Fallbacks" icon="layer-group" href="/guides/use-cases/combining-routing-strategies#per-leg-fallbacks-in-a-load-balancer">
    Each load-balanced slot has its own failover. An OpenAI outage only affects that leg — Anthropic traffic continues uninterrupted.
  </Card>
</CardGroup>
