...
The `@provider-slug/model-name` format references AI Providers set up in your [Model Catalog](/product/model-catalog). See the [full guide with code samples](/guides/use-cases/combining-routing-strategies).
</Accordion>
