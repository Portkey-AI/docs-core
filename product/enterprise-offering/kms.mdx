...
description: Customers can bring their own encryption keys to Portkey AI to encrypt data at rest.
---
This document outlines how customers can bring their own encryption keys to Portkey AI to encrypt data at rest.

## Overview

Portkey AI supports integration with Key Management Services (KMS) to encrypt data at rest. This integration allows customers to manage their encryption keys and data protection policies through their existing KMS infrastructure.
...
Envelope encryption is used to encrypt data at rest. The data is encrypted with a key that is stored in the KMS provider.
