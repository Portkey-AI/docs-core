...
<Warning>
This documentation applies exclusively to **Hybrid** and **Airgapped** deployments of Portkey Enterprise Gateway. SaaS customers should use the [Analytics Dashboard](/product/observability/analytics) for monitoring and observability.
</Warning>
