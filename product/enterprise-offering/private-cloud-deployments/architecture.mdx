...
### Sample Files
<CardGroup >
  <Card title="4KB Sample Log File" href="https://github.com/Portkey-AI/docs-core/tree/main/images/enterprise/private-cloud-deployments/architecture/sample_log_file.json"/>
  <Card title="3KB Metric File" href="https://github.com/Portkey-AI/docs-core/tree/main/images/enterprise/private-cloud-deployments/architecture/sample_metric_file.json"/>
</CardGroup>
