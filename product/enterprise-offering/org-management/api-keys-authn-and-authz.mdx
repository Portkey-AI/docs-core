...
<AccordionGroup>
  <Accordion title="Organization Management" icon="building">
    ...
    | `organisation_exclusions.update` | Exempt workspaces from [organisation-level guardrails](/product/administration/enforce-orgnization-level-guardrails#excluding-workspaces) |
