...
Organizations using LDAP can enable SCIM provisioning through identity provider bridges. See our [LDAP Integration guide](/product/enterprise-offering/org-management/ldap).
</Note>
