...
<CardGroup cols={3}>
  <Card title="SSO Documentation" icon="lock" href="/product/enterprise-offering/org-management/sso" arrow="true" />
  <Card title="SCIM Documentation" icon="shield" href="/product/enterprise-offering/org-management/scim" arrow="true" />
</CardGroup>
...
<Steps>
  ...
  <Step title="Set Up Portkey Integration">
    - Create SAML application following [SSO guide](/product/enterprise-offering/org-management/sso#okta)
    - Enable SCIM provisioning per [SCIM guide](/product/enterprise-offering/org-management/scim/okta)
...
* Review our [SSO documentation](/product/enterprise-offering/org-management/sso) for authentication setup
* Configure [SCIM provisioning](/product/enterprise-offering/org-management/scim) for user management
* Contact [Portkey support](https://support.portkey.ai/forms/customer-portal-ticket-form) for integration help
