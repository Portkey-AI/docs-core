...
Audit logs capture a wide range of administrative activities, including:

- **Resource Creation**: New workspaces, API keys, virtual keys, configs, etc.
- **Resource Updates**: Modifications to existing resources
- **Resource Deletion**: Removal of resources from the platform
- **Publishing Actions**: Publishing of prompts or other resources
- **Export Operations**: Data exports from the platform
- **Key Rotation**: Rotation of API keys
- **User Management**: Adding or removing users, changing permissions
- **Organization Updates**: Changes to organization-level settings
