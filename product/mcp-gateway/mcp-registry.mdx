...
<Frame>
  <img src="../../MCP Design Files (11)/With Data.png" alt="MCP Registry showing connected servers" />
</Frame>

<Info>
**Developer note:** Most developers won't add servers here. After an org admin provisions a server to your team/workspace, you'll use it from your **workspace MCP page** (where you can copy the connection URL and test tools).
</Info>

From the MCP Registry, you can:
- Add new MCP servers (from catalog or custom URL)
- Configure authentication for each server
- See connection status and health metrics
- Control which teams can access which servers
- Manage capabilities (tools, resources, prompts) per server

<Card title="Quickstart" icon="rocket" href="/product/mcp-gateway/quickstart">
  New to MCP Gateway? Follow the quickstart to add your first server in 5 minutes.
</Card>
...
To add a server, go to **MCP Registry** and click **Add MCP Integration**.
...
<Info>
This section covers how Portkey authenticates to **upstream MCP servers**. For how your agents authenticate to Portkey, see [Gateway Authentication](/product/mcp-gateway/authentication).
</Info>
...
<Card title="Authentication Deep Dive" icon="lock" href="/product/mcp-gateway/authentication">
  Learn about gateway authentication, external OAuth, identity forwarding, JWT validation, and more.
</Card>
...
<Frame>
  <img src="../../MCP Design Files (11)/3.png" alt="Server overview page" />
</Frame>
...
<Card title="Integrations" icon="plug" href="/product/mcp-gateway/integrations">
  See setup guides for Claude Desktop, Cursor, Python SDK, TypeScript SDK, and more.
</Card>
