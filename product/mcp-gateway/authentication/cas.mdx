...
<Warning>
**Self-hosted MCP Gateway only.** OAuth in SCM currently works only with self-hosted (enterprise) MCP Gateway deployments. It is not available on the Portkey-managed cloud gateway.
</Warning>
