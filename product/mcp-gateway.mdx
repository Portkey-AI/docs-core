...
Connect to any MCP server—whether it's the official github server, a community database connector, or your custom internal tool. If it speaks MCP, we speak to it.
