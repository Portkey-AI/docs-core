...
Before you can create and manage prompts, you'll need to set up your [Virtual Keys](/product/ai-gateway/virtual-keys). After saving the key, the respective AI provider can be used to run and manage prompts.
