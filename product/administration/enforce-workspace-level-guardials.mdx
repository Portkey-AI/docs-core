...
Once configured, these guardrails will be enforced on all API requests within the workspace, regardless of the authentication method used (workspace API keys or JWT tokens).
