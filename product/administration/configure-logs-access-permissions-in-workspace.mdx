...
<Note>
  The <b>Admins</b> permission column in Logs Management is controlled through an enterprise feature flag and is available only for allowlisted organizations.
</Note>
...
The Logs Management section provides permission options for Admins (allowlisted organizations), Managers, and Members:
...
| **Admins View Logs** | Allow workspace admins to view logs within their workspace |
| **Admins View Logs Metadata** | Allow workspace admins to view logs metadata within their workspace |
