...
| **Org-Admins View Logs** | Allow organization admins to view logs within workspaces |
| **Org-Admins View Logs Metadata** | Allow organization admins to view logs metadata within workspaces |
