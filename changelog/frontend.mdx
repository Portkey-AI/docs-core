...
<Update label="1.6.7" description="2026-04-07">

## v1.6.7
---

### Fixes and Improvements
- Added support for Logs Management security settings for workspace Admins (feature-flag rollout).
- Added audit metadata enrichment for logs security setting updates to improve traceability.
