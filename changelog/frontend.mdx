...
- Removed workload validation to streamline workspace configuration
- Fixed an issue where members could not see the correct models in the Providers list
- Added support for copying workspaces, making it easier to duplicate workspace configurations
- Added workspace budget usage check with the ability to reset budget usage
- Security patch - Updated libpng library to address a security vulnerability
