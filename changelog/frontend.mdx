...
- Added support to display Spans w/o filters and UI to toggle between
...
- Display option to add missing User API key if Generations or Completions calls are blocked
- Bug fixes and performance improvements
