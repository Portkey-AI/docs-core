...
<Update label="1.7.5" description="2026-04-21">
...
- Support for Org-only Admin logs permissions and excluded Admin controls from workspace settings
- Support for Guardrail Management controls in org/workspace security settings
- Added userType to guardrail items
