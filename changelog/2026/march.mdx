...
We’ve also rolled out upgrades across the platform, observability, and provider coverage, giving teams more reliable infrastructure and broader model access.
...
If you use Portkey in production, you can [share a review on Gartner Peer Insights](https://www.gartner.com/reviews/observability-platforms/form?vid=91488&pid=172430). When Gartner approves your submission, you may be eligible for a **gift card from Gartner** under their reviewer program (terms apply on Gartner’s side).

Your feedback helps other teams evaluate AI gateways and observability tools—and we’re grateful for the time you take to write it.
