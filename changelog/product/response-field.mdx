...
<ResponseField name="Executive Summary">
...
- **Caching Calculations**: Improved cost calculations for OpenAI & Azure OpenAI cached responses
- **Anthropic Prompt Caching**: Added support for Anthropic's prompt caching feature directly in prompt playground
- **Gemini Updates**: Added support for Gemini JSON mode and Controlled Generations for Gemini models, along with Pydantic support
...
<ResponseField name="Models & Providers">
...
<ResponseField name="Community Updates">
