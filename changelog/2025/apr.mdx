...
- You can now store and retrieve vector embeddings for semantic cache using Milvus in Portkey. Read more in [Cache (Simple & Semantic)](https://portkey.ai/docs/product/ai-gateway/cache-simple-and-semantic#set-up-semantic-caching-self-hosted).
