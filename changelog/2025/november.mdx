...
On the platform side, we expanded our provider landscape, shipped multiple model releases on Day 0, and worked on deepening our capabilities.
...
| Area | Key Highlights |
|---|---|
| **Models & Providers** | • GPT-5.1 <br />• Gemini 3.0 + Thought messages for Gemini Pro<br />• Claude Opus 4.5 <br />• Vertex Computer Use + Anthropic-beta header + new audio formats<br />• New providers: Z_AI, MatterAI CometAPI |
| **Platform** | • Conditioner Router now supports URL-based conditions<br />• Usage limits & rate-limit policies for org-wide control |
| **Guardrails** | • F5 Guardrail added<br />• Javelin Guardrails added |
...
<img src="/images/changelog/url-path.png" alt="trace-category" style={{maxWidth: "80%", borderRadius: "8px", margin: "24px 0"}} />
...
<img src="/images/changelog/url-path.png" alt="guardrails-checks-in-logs" style={{maxWidth: "80%", borderRadius: "8px", margin: "24px 0"}} />
