...
sidebarTitle: "Enterprise Gateway [1.15.7]"
rss: true
---
...
### Provider Updates
- AWS Bedrock:
    - **Fixed** `cache_control` mapping for tools in Bedrock messages endpoint request transformer. 
    - **Fixed** stream response chunk handling for `content_block_start` events for `tool_use`, `thinking`, and `redacted_thinking`
