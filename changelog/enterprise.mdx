...
- **MCP Gateway**: A repeated OAuth callback no longer shows an `invalid_state` error when the connection has already succeeded. [Docs](/product/mcp-gateway/authentication/external-oauth)
