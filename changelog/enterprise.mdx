...
- **Revert**: Removed the multi-layer Vertex AI pricing which caused zero cost attribution in v2.6.1
...
### Provider Updates
- **VertexAI**: Added support for Computer Use. See [documentation](https://portkey.ai/docs/integrations/llms/vertex-ai#computer-use-browser-automation-preview).
