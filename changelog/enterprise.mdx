...
- **VertexAI**: Added support for video generation (Veo models) cost calculation
...
- <Info>When the environment variable is updated, existing logs will remain in the same format</Info>
