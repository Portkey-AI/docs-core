...
- **Metrics endpoint**: Gated behind an env flag for opt-in exposure
...
- **Stored logs**: Integration model catalog stripped from request logs to reduce log size
- **Security**: Strengthened input validation on data plane endpoints
- Updated dependencies to patch security vulnerabilities
