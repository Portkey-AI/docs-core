...
sidebarTitle: "Enterprise Gateway [2.2.3]"
rss: true
---
...
Added support for [Databricks Model Serving](https://docs.databricks.com/en/machine-learning/model-serving/index.html) as a new provider with support for chat completions, completions, and embeddings.
