...
- **Pricing**: Pricing for Voyage, Lightning AI, and Scenario AI is now bundled with the gateway, so air-gapped deployments track spend for these providers correctly instead of logging zero cost. [Model Catalog](/product/model-catalog)
