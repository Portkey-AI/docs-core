...
- **Gemini/Vertex AI**: Added support for minimal thinking mode (`budget_tokens: 0`) for Gemini 2.5 models
...
- Fixed Redis circular dependency issue through internal code refactoring
