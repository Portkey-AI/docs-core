...
### OAuth Support in Prisma AIRS AI Gateway via Cloud Identity Engine

OAuth is now supported in Prisma AIRS AI Gateway through Palo Alto Networks Cloud Identity Engine (CIE). You can sync your data plane user directory through CIE and then use it for the OAuth flow.
