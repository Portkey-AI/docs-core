...
- **Plugins**: Plugin ID lookup is case-insensitive
- **Stream parsing**: SSE comment chunks skipped to avoid spurious parse errors
- **Security**: Bumped `protobufjs` for [CVE-2026-45740](https://nvd.nist.gov/vuln/detail/CVE-2026-45740); additional audit fixes
