...
sidebarTitle: "Enterprise Gateway [1.16.3]"
rss: true
---
...
### Provider Updates
- Add support for streaming audio transcription requests.
- Enable custom model support for batch inference with the vertex-ai provider.
