...
<Frame>
  <img src="/images/guardrails/rbac-hierarchy.webp"/>
</Frame>
...
<Note>
  **Workspaces** is currently a feature only enabled on the **Enterprise Plans**. If you're looking to add this feature to your organisation, please reach out to [Portkey support](https://support.portkey.ai/forms/customer-portal-ticket-form)
</Note>
