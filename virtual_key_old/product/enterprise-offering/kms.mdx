...
To enable KMS for AWS in your Portkey Enterprise self hosted control plane deployment. Please reach out to your Portkey representative or contact [Portkey support](https://support.portkey.ai/forms/customer-portal-ticket-form).
</Note>
