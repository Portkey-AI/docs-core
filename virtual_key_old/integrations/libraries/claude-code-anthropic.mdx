...
Go to [Virtual Keys](https://app.portkey.ai/virtual-keys) → **Add Virtual Key** → Select **Anthropic**.
...
Some Claude Code features require the `anthropic-beta` header. Configure this in a [Portkey Config](/virtual_key_old/product/ai-gateway/configs):
...
1. Go to [Virtual Keys](https://app.portkey.ai/virtual-keys) → Select your Anthropic virtual key
2. Click **Edit**
3. Configure:
