...
Go to [Virtual Keys](https://app.portkey.ai/virtual-keys) → **Add Virtual Key** → Select **Google Vertex AI**.
...
Some Claude Code features require the `anthropic-beta` header to reach Vertex AI. Configure this in a [Portkey Config](/virtual_key_old/product/ai-gateway/configs):
