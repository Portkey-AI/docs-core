...
<Steps>
  <Step title="Create Portkey API Key">
    ...
    4. Save and copy the key — you’ll need it for OpenWebUI.
  </Step>
...
<Steps>
  <Step title="Access Admin Panel">
    ...
    5. Select **Connections** from the sidebar.
    <Frame>
  ...
  <Step title="Enable Direct Connections">
    1. Toggle **Direct Connections** to enable.
    2. Toggle **OpenAI API** to enable.
  ...
  <Step title="Select and Use Your Model">
    ...
    2. Open the model selector dropdown at the top.
