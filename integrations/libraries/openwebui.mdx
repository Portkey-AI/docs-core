...
## Advanced Features
Portkey's advanced features can be implemented through [Configs](docs-core/product/ai-gateway/configs) in OpenWebUI. These configs are JSON objects that control routing, guardrails, prompts, and more.
...
This configuration automatically routes requests to different models based on the user's plan. [Learn more](docs-core/product/ai-gateway).
