...
Since Portkey [seamlessly connects to 150+ models across providers](/docs/integrations/llms), you can easily connect any of these to now run with Autogen.
...
[Virtual keys](/docs/product/ai-gateway/virtual-keys) in Portkey allow you to easily switch between providers without manually having to store and change their API keys. Let's use the same Mistral example above, but this time using a Virtual Key.
...
[Configs](/docs/product/ai-gateway/configs) in Portkey unlock advanced management and routing functionality including [load balancing](/docs/product/ai-gateway/load-balancing), [fallbacks](/docs/product/ai-gateway/fallbacks), [canary testing](/docs/product/ai-gateway/canary-testing), [switching models](/docs/product/ai-gateway/universal-api) and more.
