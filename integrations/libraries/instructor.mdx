...
Similarly, you can add [Fallback](/docs/product/ai-gateway/fallbacks), [Loadbalancing](/docs/product/ai-gateway/load-balancing), [Timeout](/docs/product/ai-gateway/request-timeouts), or [Retry](/docs/product/ai-gateway/automatic-retries) settings to your Configs and make your Instructor requests robust & reliable.
