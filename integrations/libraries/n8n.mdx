---
title: 'n8n'
description: 'Add usage tracking, cost controls, and security guardrails to your n8n workflows'
---
...
<Note>
  If you are an enterprise looking to use n8n in your organisation, [check out this section](#3-set-up-enterprise-governance-for-n8n).
</Note>
...
<Note>
You need your Portkey API Key from [Step 1](#Setting-up-portkey) before going further.
</Note>
...
<Note>
It is recommended to define a comprehensive config in Portkey with your preferred settings. This allows you to maintain all LLM settings in one place, while still being able to override specific parameters like the model name directly in your n8n workflow.
</Note>
...
If you are using n8n inside your organization, you need to consider several governance aspects:
...
Create your config on the [Configs page](https://app.portkey.ai/configs) in your Portkey dashboard. You'll need the config ID for connecting to n8n's setup.
...
After distributing API keys to your team members, your enterprise-ready n8n setup is ready to go. Each team member can now use their designated API keys with appropriate access levels and budget controls.
