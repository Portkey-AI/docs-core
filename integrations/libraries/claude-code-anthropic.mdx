...
Claude Code is Anthropic's agentic coding tool. Route it through Anthropic's Direct API via Portkey to get:

- **Observability** — Track costs, tokens, latency, and traces for every request
...
Enable semantic caching to reduce costs and latency for repeated queries:
