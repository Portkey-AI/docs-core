...
providers:
  ...
  config:
    ...
    portkeyVirtualKey: ANTHROPIC_PROVIDER
```
...
providers:
  ...
  config:
    ...
    portkeyVirtualKey: GEMINI_PROVIDER
```
  </Tab>
  <Tab title="Groq">
...
providers:
  ...
  config:
    ...
    portkeyVirtualKey: GROQ_PROVIDER
```
  </Tab>
  <Tab title="Ollama">
...
providers:
  id: portkey:xxx
  config:
    portkeyVirtualKey: YOUR_PORTKEY_AZURE_OPENAI_PROVIDER
```
...
providers:
  ...
  config:
    portkeyVirtualKey: YOUR_PORTKEY_AWS_BEDROCK_PROVIDER
...
providers:
  id: portkey:gemini-1.5-flash-latest
  config:
    portkeyVirtualKey: YOUR_PORTKEY_GOOGLE_VERTEX_AI_PROVIDER
```
