...
<Accordion title="Can I use Portkey with the open source Codex CLI?">
Yes! Portkey fully integrates with [OpenAI's open source Codex CLI](https://github.com/openai/codex).
</Accordion>
