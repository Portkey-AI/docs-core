...
If you are using OpenAI Codex inside your orgnaization, you need to consider several governance aspects:
...
Create your config on the [Configs page](https://app.portkey.ai/configs) in your Portkey dashboard. You'll need the config ID for connecting to OpenAI Codex's setup.
