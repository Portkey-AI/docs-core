...
For organizations deploying Roo across development teams, Portkey provides:
...
<Accordion title="How do I prevent sensitive data exposure?">
Use Portkey's [Guardrails](/product/guardrails) for:
- API key detection
- PII masking
...
Schedule a 1:1 call with our team to see how Portkey can transform your development workflow with Roo
</Card>
