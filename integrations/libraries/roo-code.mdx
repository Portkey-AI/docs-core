...
<Note>
  If you are an enterprise looking to standardize Roo usage across your development teams, [check out this section](#3-set-up-enterprise-governance-for-roo).
</Note>



# 1. Setting up Portkey
Portkey allows you to use 1600+ LLMs with your Roo Code setup, with minimal configuration required. Let's set up the core components in Portkey that you'll need for integration.
...
<Note>
Save your API key securely - you'll need it for Roo Code integration.
</Note>
...
You can now use Roo with all of Portkey's enterprise features enabled. Monitor your requests and usage in the [Portkey Dashboard](https://app.portkey.ai/dashboard).



# 3. Set Up Enterprise Governance for Roo Code

**Why Enterprise Governance?**
If you are using Roo Code inside your orgnaization, you need to consider several governance aspects:
...
Create your config on the [Configs page](https://app.portkey.ai/configs) in your Portkey dashboard. You'll need the config ID for connecting to Roo Code's setup.
...
After distributing API keys to your engineering teams, your enterprise-ready Roo Code setup is ready to go. Each developer can now use their designated API keys with appropriate access levels and budget controls.
...
<Accordion title="Can I use Roo with local or self-hosted models?">
