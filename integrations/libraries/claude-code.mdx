...
- Currently you can only use Claude models on Claude code using any provider (Bedrock, Vertexl, and Anthtropic)
</Note>
...
3. Select the config that you created from the previous step
