---
title: 'Anything LLM'
description: 'Add usage tracking, cost controls, and security guardrails to your Anything LLM deployment'
---
...
Integrate your LLM provider API keys in Portkey. You can:
- Set Budget limits for API usage
- Set Rate limits on requests or tokens
- Provision the integration to specific teams

When you create an integration, you will get a provider name that you can use in your Anything LLM setup.
</Step>
...
<Note>
This basic config connects to your provider. You can add more advanced portkey features later.
</Note>
</Step>
