...
<Note>
Add `cache_control` to your config to enable prompt caching and optimize costs.
</Note>
...
<Frame>
<img src="/images/libraries/cursor-portkey-model-add.png"/>
</Frame>

<Frame>
<img src="/images/libraries/cursor-portkey-model-enabled.png"/>
</Frame>

6. In **Chat**, open the model picker and select that custom model so every message goes through Portkey.

<Frame>
<img src="/images/libraries/portkey-model-picker.png"/>
</Frame>
