...
Go to [Model Catalog](https://app.portkey.ai/model-catalog) in the Portkey App to add your AI provider key and copy the AI Provider slug.
</Step>

<Step title="Create Config">
Go to [Configs](https://app.portkey.ai/configs) in the Portkey App, create a new config that uses your AI Provider slug, then save the Config ID.
</Step>
...
<Steps>
  <Step title="1. Add an AI Provider">
Add your provider credentials to [Model Catalog](https://app.portkey.ai/model-catalog) and set budget and rate limits.
