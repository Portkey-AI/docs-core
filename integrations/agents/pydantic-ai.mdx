...
portkey_client = AsyncPortkey(
    ...
    virtual_key="YOUR_PROVIDER_VIRTUAL_KEY",  # Optional, if using virtual keys
...
portkey_client = AsyncPortkey(api_key="YOUR_PORTKEY_API_KEY", virtual_key="YOUR_OPENAI_VIRTUAL_KEY")
