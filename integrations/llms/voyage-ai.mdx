...
<Card title="SDK" icon="link" href="/docs/api-reference/portkey-sdk-client">
...
2. [Add gateway configs to your Voyage requests](/docs/product/ai-gateway/configs)
3. [Tracing Voyage requests](/docs/product/observability/traces)
4. [Setup a fallback from OpenAI to Voyage APIs](/docs/product/ai-gateway/fallbacks)
