...
<Note>
  OpenRouter also proxies typed-judgment requests to models like TypeSafe's Jev. Route these through `/v1/decisions` with `x-portkey-provider: @openrouter`. See [TypeSafe (Jev)](/integrations/llms/typesafe).
</Note>
