...
<Steps>
  ...
  <Step title="Add OpenAI to Model Catalog">
    Add your OpenAI API key to [Model Catalog](https://app.portkey.ai/model-catalog) to create an AI Provider. This gives you centralized key management with [budget limits](/product/model-catalog/budget-limits) and rate limits per provider.
  </Step>
