...
<Steps>
  ...
  <Step title="Create a Virtual Key in Portkey">
    Portkey's virtual key vault simplifies your interaction with OpenAI. Virtual keys act as secure aliases for your actual API keys, offering enhanced security and easier management through [budget limits](/product/observability/budget-limits) to control your API usage.

    Use the Portkey app to create a [virtual key](/product/ai-gateway/virtual-keys) associated with your OpenAI API key.
  </Step>
