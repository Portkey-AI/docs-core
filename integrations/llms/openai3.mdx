---
title: 'OpenAI'
description: Complete guide to integrate OpenAI API with Portkey. Support for gpt-4o, o1, more models, chat, embeddings, vision, audio, fine-tuning, batch APIs with built-in reliability, monitoring, and cost optimization features.
---
---
...
OpenAI's API provides access to powerful language models (gpr-4o, o1), embedding models, and multimodal capabilities including vision and speech. Portkey's OpenAI integration enhances these APIs with production-ready features like full-stack observability, fallbacks, loadbalancing, automatic retries, caching, guardrails, and more. This integration supports all OpenAI endpoints including chat completions, embeddings, fine-tuning, and batch processing, and more.
