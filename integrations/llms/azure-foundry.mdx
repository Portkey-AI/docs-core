...
<ResponseField name="Provider Slug" type="azure-ai">
[API Status](https://status.portkey.ai/) | [Supported Endpoints](/api-reference/inference-api/supported-providers)
</ResponseField>
...
Each deployment type requires specific configuration parameters like resource names, API versions, and authentication tokens.
...
<Tabs>
  ...
  <Frame>
    <img src="/images/llms/azure-foundry/default-auth.png" alt="Default Authentication Setup" />
  </Frame>
  ...
  <Info>
  To find your API Key and other deployment details, navigate to your Azure AI Foundry resource in the Azure portal and check the "Keys and Endpoint" section.
  </Info>
  </Tab>
  ...
  <Frame>
    <img src="/images/llms/azure-foundry/managed-auth.png" alt="Managed Authentication Setup" />
  </Frame>
  ...
  <Info>
  For managed deployments, you can find the client ID and other details in the Azure AI Foundry Studio under your deployment settings.
  </Info>
  </Tab>
  ...
  <Frame>
    <img src="/images/llms/azure-foundry/entra-auth.png" alt="Entra Authentication Setup" />
  </Frame>
  ...
  <Info>
  You can find your Azure Entra details in the Azure Active Directory portal. For new applications, you'll need to register an app and create a client secret.
  </Info>
  </Tab>
</Tabs>
...
When setting up your Azure AI Foundry deployments, you'll have several options:

### Serverless API

This option offers a managed API service without requiring you to host or manage infrastructure. You can optionally include standard Azure AI Content Safety filters.
...
This option provides user-managed hosting and model inferencing on Azure infrastructure. This gives you more control over your deployments but requires more management overhead.

## Available Models in Azure AI Foundry

Azure AI Foundry offers a diverse range of models from various providers, including:
