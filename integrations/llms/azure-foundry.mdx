...
<Card href="/integrations/llms/azure-openai" title="OpenAI modes on Azure">
...
<Frame>
  <img src="/images/product/model-catalog/integrations-page.png" alt="Creating Azure AI Foundry Integration" />
</Frame>
...
2. **Azure Target URI**: From your Foundry console, you'll get a URL like:
   ...
   ```
   You need to use the full URL including `/anthropic/v1/messages`:
   ```
   https://resource-name-swedencentral.services.ai.azure.com/anthropic/v1/messages
   ```
...
2. Configure the model with these details:
   ...
   - **Base Model**: Search for and select your Anthropic model (e.g., `claude-opus-4-1-20250805`, `claude-sonnet-4-20250514`, etc.)
