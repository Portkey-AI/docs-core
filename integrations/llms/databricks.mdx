...
<Info>
**Pricing in Logs:** Databricks currently only supports [custom pricing](/product/model-catalog/custom-models). Cost data will only appear in your Portkey logs if you configure custom pricing for your Databricks models in the Model Catalog.
</Info>
