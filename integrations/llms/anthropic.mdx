...
Anthropic Claude models support web search as a tool, allowing the model to search the web for up-to-date information. To receive citations in the response, set `strict_open_ai_compliance` to `false`.
