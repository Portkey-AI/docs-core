...
<Note>
    Anthropic's PDF Support is also available similary on [Google Vertex AI](/integrations/llms/vertex-ai) and [AWS Bedrock](/integrations/llms/bedrock/aws-bedrock).
</Note>
