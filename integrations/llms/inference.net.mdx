...
2. [Add gateway configs to your Inference.net requests](/docs/product/ai-gateway/configs)
3. [Tracing Inference.net requests](/docs/product/observability/traces)
4. [Setup a fallback from OpenAI to Inference.net](/docs/product/ai-gateway/fallbacks)
