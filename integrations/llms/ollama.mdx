...
For production environments, you can store your self-hosted LLM configuration in Portkey's secure vault using Virtual Keys:
...
Here's a simple, standardized section that you can copy and paste into all self-hosted LLM integration docs (like Ollama, vLLM, etc.):
