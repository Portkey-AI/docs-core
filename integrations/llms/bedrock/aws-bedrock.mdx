...
When creating your Bedrock AI Provider in Portkey's Model Catalog, configure the custom host with the GovCloud endpoint:
...
<Frame>
    <img src="/images/integrations/aws-gov-cloud-integartion.png" alt="Configure Custom Host for AWS GovCloud" />
</Frame>
