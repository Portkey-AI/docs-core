...
Vertex AI supports adding custom metadata labels to your API calls for cost tracking and attribution. Pass labels in your request body or configure them in your gateway config using `override_params`.
...
<Note>
Labels are Vertex AI-specific and forwarded to GCP for cost analysis. [Learn more](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/multimodal/add-labels-to-api-calls)
</Note>
