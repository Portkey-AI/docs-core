...
<Tabs>
  <Tab title="NodeJS SDK">
    ...
    const portkey = new Portkey({
        ...
        provider:"@VERTEX_PROVIDER", // Your Vertex AI Virtual Key
    })
    ```
  </Tab>
  <Tab title="Python SDK">
    ...
    portkey = Portkey(
        ...
        provider="@VERTEX_PROVIDER"   # Replace with your virtual key for Google
    )
    ```
  </Tab>
</Tabs>
...
<Tabs>
    <Tab title="cURL">
        ...
        --header 'x-portkey-provider: @your-vertex-provider-slug' \
