...
title: "GitHub Models"
description: Use GitHub Models Marketplace through Portkey for AI model integration.
---
...
GitHub Models Marketplace provides access to various AI models for both chat completions and embeddings:
...
Check [GitHub Models Marketplace](https://github.com/marketplace/models) for the complete and up-to-date model list.
