...
<Card title="Ready to maximize your AWS investment? | Booke a call" href="https://portkey.sh/bedrockdocs">Schedule a 1:1 architecture review</Card>
...
<CardGroup cols={3}>
  ...
  <Card title="FinOps Controls for AWS" icon="chart-line" href="/product/administration/enforce-workspace-budget-limts-and-rate-limits">
  ...
  <Card title="Compliances & Certificates" icon="certificate" href="/product/enterprise-offering/security-portkey#compliance-and-data-privacy">
...
<Card title="Booke a call" href="https://portkey.sh/aws">Schedule a 1:1 architecture review</Card>
...
<Card title="AWS Quick-Start" href="/integrations/llms/bedrock/aws-bedrock" icon="aws">
</Card>
...
<Frame>
<iframe
  src="https://portkey.sh/bedrockdocs?hide_event_type_details=1&hide_gdpr_banner=1"
  width="100%"
  height="750"
  frameBorder="0"
