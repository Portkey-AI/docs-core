...
<Card title="LLM Integrations" icon="key" href="/product/model-catalog/integrations">
...
<Card title="Rate Limits" icon="clock" href="/product/model-catalog/integrations#3-budget-%26-rate-limits">
Set spending limits per API key, team, or project. Get alerts before hitting limits.
</Card>
