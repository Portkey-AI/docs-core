...
<Card title="Get Started with Palo Alto Networks Prisma AIRS" href="https://docs.paloaltonetworks.com/ai-runtime-security"/>
...
1. **Prompt Injections**: Detects and blocks attempts to manipulate AI behavior through malicious prompts
2. **Sensitive Data Leakage**: Prevents PII, secrets, and confidential information from being exposed
3. **Insecure Outputs**: Blocks responses containing malware, malicious URLs, or harmful content
4. **Model DoS Attacks**: Protects against attempts to overwhelm or disable AI models
5. **Jailbreak Attempts**: Identifies and prevents attempts to bypass AI safety mechanisms
6. **Toxic Content**: Filters harmful, offensive, or inappropriate content
...
- [Palo Alto Networks Prisma AIRS Documentation](https://docs.paloaltonetworks.com/prisma/prisma-airs)
- [Prisma AIRS API Reference](https://docs.paloaltonetworks.com/prisma/prisma-airs/api-reference)
- [AI Security Best Practices](https://www.paloaltonetworks.com/cyberpedia/ai-security-best-practices)
