...
If you face any issues with the AWS Bedrock Guardrails integration, reach out to [Portkey support](https://support.portkey.ai/forms/customer-portal-ticket-form).
