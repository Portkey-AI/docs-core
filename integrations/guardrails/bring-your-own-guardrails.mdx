...
| **Execute on Proxy** | Run this webhook on proxy (`/v1/*`) requests. When enabled, the webhook operates in deny-only mode — transforms are ignored. Default: `false` | `boolean` |
