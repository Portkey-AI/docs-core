...
1.  **Contact Us:** Reach out to the Portkey team via [Portkey support](https://support.portkey.ai/forms/customer-portal-ticket-form), and we will enable the Model Catalog for your organization.
