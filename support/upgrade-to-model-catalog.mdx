...
As an Org Admin, you will see a new [**Integrations**](https://app.portkey.ai/integrations) tab in your organization settings. This is your central hub for managing all LLM providers.
...
As a Workspace Admin, you will now see [**Model Catalog**](https://app.portkey.ai/model-catalog) on your sidebar. The old "Virtual Keys" will be marked as deprecated.
