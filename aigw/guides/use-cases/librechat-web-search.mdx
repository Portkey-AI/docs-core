...
Transform your LibreChat experience by adding web search capabilities to any LLM - whether it's GPT-5, Claude, Llama, or any of the 1,600+ models supported by the AI Gateway. This guide shows you how to combine LibreChat, the AI Gateway, and Exa to create a powerful AI chat interface with real-time internet access.
...
- ✅ **1,600+ LLM support** - Use web search with any model through the AI Gateway
...
3. ✅ [Strata Cloud Manager account](https://app.portkey.ai) with API key
...
1. Log into your [Strata Cloud Manager](https://app.portkey.ai)
