...
<Note>
This integration builds upon the basic [LibreChat + Portkey setup](/aigw/integrations/libraries/librechat). Please complete that integration first before proceeding.
</Note>
...
2. ✅ [Basic Portkey + LibreChat integration](/aigw/integrations/libraries/librechat) completed
