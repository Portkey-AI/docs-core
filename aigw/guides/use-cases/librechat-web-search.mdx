...
> Enable real-time internet search capabilities for any LLM in LibreChat using Prisma AIRS AI Gateway's Exa integration

Transform your LibreChat experience by adding web search capabilities to any LLM - whether it's GPT-5, Claude, Llama, or any of the 3,000+ models supported by the AI Gateway. This guide shows you how to combine LibreChat, the AI Gateway, and Exa to create a powerful AI chat interface with real-time internet access.

<Note>
This integration builds upon the basic [LibreChat + AI Gateway setup](/aigw/integrations/libraries/librechat). Please complete that integration first before proceeding.
</Note>
...
- ✅ **All AI Gateway features** - Observability, caching, fallbacks, and more
- ✅ **Unified interface** - One LibreChat setup for all your AI needs
- ✅ **3,000+ LLM support** - Use web search with any model through the AI Gateway
...
<Step title="Request routes through the AI Gateway">
The AI Gateway intercepts the request and triggers the Exa plugin
</Step>
...
2. ✅ [Basic the AI Gateway + LibreChat integration](/aigw/integrations/libraries/librechat) completed
3. ✅ [Strata Cloud Manager account](https://stratacloudmanager.paloaltonetworks.com/) with API key
...
1. Go to the `Guardrails` page in the AI Gateway
...
Now create an AI Gateway config that includes your Exa guardrail:

1. Navigate to `Configs` in Strata Cloud Manager
...
2. Select **"The AI Gateway with Web Search"** as your endpoint
...
### Combining with Other AI Gateway Features

Enhance your web-search enabled config with additional AI Gateway features:
...
Track your web-search enhanced conversations in Strata Cloud Manager:

1. Navigate to **Logs** in the AI Gateway
...
- **Monitor costs** using the AI Gateway's analytics dashboard
