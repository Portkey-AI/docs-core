...
- **Responses API**: Streaming responses now report reasoning and cached token counts in `usage`, which previously always returned `0`. [Responses API Reference](/api-reference/inference-api/responses/responses)
...
[OCR API Reference](/api-reference/inference-api/ocr) · [Vertex AI Documentation](/aigw/integrations/llms/vertex-ai)
...
[Headroom Plugin Documentation](https://portkey.ai/docs/integrations/guardrails/headroom)
...
[OCR API Reference](/api-reference/inference-api/ocr) · [Mistral AI Documentation](/aigw/integrations/llms/mistral-ai#ocr-document-processing) · [Azure AI Foundry Documentation](/aigw/integrations/llms/azure-foundry#ocr-document-processing)
...
[Rate Limits Documentation](/aigw/product/model-catalog/rate-limits)
...
- More details: [Documentation](/aigw/product/enterprise-offering/budget-policies) and [API Reference](/api-reference/admin-api/control-plane/policies)
...
- Export logs without them being sent to Management Plane [Docs Link](/api-reference/admin-api/data-plane/logs/log-exports-beta)
