...
[Anthropic `service_tier` → `speed` mapping](/aigw/integrations/llms/anthropic#service-tier)
...
- [Docs Link](/aigw/integrations/llms/bedrock/prompt-caching#how-bedrock-prompt-caching-works)
...
- More Details:
    ...
    - [AWS Bedrock](/aigw/integrations/llms/bedrock/aws-bedrock#extended-thinking-reasoning-models-beta)
    - [VertexAI](/aigw/integrations/llms/vertex-ai#extended-thinking-reasoning-models-beta)
