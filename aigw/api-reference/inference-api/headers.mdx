---
title: Headers
description: Header requirements and options for Prisma AIRS AI Gateway API
---
...
List of [the AI Gateway supported providers here](/aigw/integrations/llms).
</ResponseField>
...
<ResponseField name="x-portkey-provider / provider" type="string">
Specify your AI Provider slug (from [Model Catalog](/aigw/product/model-catalog)) to route requests through a managed provider. Use the `@provider-slug` format. ([Docs](/aigw/product/model-catalog))
...
* Configs can be saved in Strata Cloud Manager and referenced by their ID ([Docs](/aigw/product/ai-gateway/configs))
...
Specifies the base URL where you want to send your request. The AI Gateway validates custom host URLs and blocks private/reserved IP ranges by default. See [Custom hosts](/aigw/product/ai-gateway/custom-hosts) for details.
</ResponseField>
<ResponseField name="x-portkey-provider / provider" type="string">
...
An ID you can pass to refer to one or more requests later on. If not provided, the AI Gateway generates a trace ID automatically for each request. ([Docs](/aigw/product/observability/traces))
</ResponseField>
<Accordion title="Example">
<CodeGroup>
...
You can include the special metadata type `_user` to associate requests with specific users. ([Docs](/aigw/product/observability/metadata))
</ResponseField>
<Accordion title="Example">
<CodeGroup>
...
Expects `true` or `false` See the caching documentation for more information. ([Docs](/aigw/product/ai-gateway/cache-simple-and-semantic))
</ResponseField>
<Accordion title="Example">
<CodeGroup>
...
If you need both behaviours, use:
...
| **Config** The slug or [config object](/aigw/api-reference/inference-api/config-object) to use | stringobject | `config` |
| **Provider** The AI provider to use for your calls. ([supported providers](/aigw/integrations/llms#supported-ai-providers)). | string | `provider` |
| **Base URL** You can edit the URL of the gateway to use. Needed if you're [self-hosting the AI gateway](/aigw/self-hosting/hybrid-deployments/architecture) | string | `baseURL` |
...
| **Config** The slug or [config object](/aigw/api-reference/inference-api/config-object) to use | stringobject | `config` |
| **Provider** The AI provider to use for your calls. ([supported providers](/aigw/integrations/llms#supported-ai-providers)). | string | `provider` |
| **Base URL** You can edit the URL of the gateway to use. Needed if you're [self-hosting the AI gateway](/aigw/self-hosting/hybrid-deployments/architecture) | string | `base_url` |
...
| **Config** The slug or [config object](/aigw/api-reference/inference-api/config-object) to use | string | `x-portkey-config` |
| **Provider** The AI provider to use for your calls. ([supported providers](/aigw/integrations/llms#supported-ai-providers)). | string | `x-portkey-provider` |
| **Base URL** You can edit the URL of the gateway to use. Needed if you're [self-hosting the AI gateway](/aigw/self-hosting/hybrid-deployments/architecture) | string | Change the request URL |
