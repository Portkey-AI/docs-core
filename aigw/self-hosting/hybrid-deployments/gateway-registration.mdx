...
description: "Register your self-hosted AI Gateway with Prisma AIRS AI Gateway to enable configuration sync, analytics, and workspace access control."
---
...
Gateway Registration connects your self-hosted AI Gateway to the Management Plane. Once registered, the Data Plane can pull promt templates, routing configs,integrations, API keys etc.
...
- **Last Sync** — elapsed time since the most recent sync between the data plane and management plane.
...
| `PORTKEY_API_KEY` | Your AI Gateway API key |
