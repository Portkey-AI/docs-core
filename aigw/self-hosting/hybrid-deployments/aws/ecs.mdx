...
```hcl
# Replace with the Management Plane CIDRs provided by the Palo Alto Networks team
allowed_lb_cidrs = ["203.0.113.10/32", "203.0.113.11/32"]
```
