...
Guardrails are the **only** supported way to pass guardrail checks to a provider batch request. Define them in a [AI Gateway config](/aigw/product/ai-gateway/configs) [here](https://app.portkey.ai/configs):
