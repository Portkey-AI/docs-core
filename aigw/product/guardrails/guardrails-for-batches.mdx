...
description: "Secure batch inference with Portkey Guardrails"
---
...
Portkey supports running [guardrails](/aigw/product/guardrails) on [provider batch requests](/api-reference/inference-api/batch/create-batch). You pass guardrails through a [config](/aigw/product/ai-gateway/configs),
...
Guardrails are the **only** supported way to pass guardrail checks to a provider batch request. Define them in a [Portkey config](/aigw/product/ai-gateway/configs) [here](https://app.portkey.ai/configs):
