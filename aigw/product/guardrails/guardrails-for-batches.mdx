...
The AI Gateway supports running [guardrails](/aigw/product/guardrails) on [provider batch requests](/aigw/api-reference/batch/create-batch). You pass guardrails through a [config](/aigw/product/ai-gateway/configs),
