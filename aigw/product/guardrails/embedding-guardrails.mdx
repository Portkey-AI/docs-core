...
Add your guardrail ID to the `before_request_hooks` in your Portkey [config](/aigw/product/ai-gateway/configs):
...
- [Portkey Guardrails Overview](/aigw/product/guardrails)
