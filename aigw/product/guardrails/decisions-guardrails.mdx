...
The Prisma AIRS AI Gateway's guardrails also cover `/v1/decisions`, the typed-judgment endpoint. [TypeSafe's Jev](/aigw/integrations/llms/typesafe) is the first supported provider, with more planned. This lets you screen the content a decision is made about before it reaches the model, the same way you would for a chat or embedding request.
