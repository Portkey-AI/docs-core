...
<CardGroup cols={3}>
  <Card
    title="Acuvity"
    href="/aigw/integrations/guardrails/acuvity"
  ...
  <Card
    title="Aporia"
    href="/aigw/integrations/guardrails/aporia"
    img="/images/product/Guardrails/Aporia.jpg"
  >
    * Validate custom Aporia policies via project ID * Define policies on your
    Aporia dashboard * Seamless integration with Prisma AIRS AI Gateway checks
  </Card>
  <Card
    title="AWS Bedrock"
    href="/aigw/integrations/guardrails/bedrock-guardrails"
    img="/images/product/Guardrails/Bedrock.jpg"
  >
    * Analyze and redact PII to prevent manipulation * Integrate AWS Guardrails
    directly in the AI Gateway * Advanced security policy enforcement
  </Card>
  <Card
    title="Azure"
    href="/aigw/integrations/guardrails/azure-guardrails"
  ...
  <Card
    ...
    href="/aigw/integrations/guardrails/javelin"
  ...
  <Card
    ...
    href="/aigw/integrations/guardrails/lasso"
  ...
  <Card
    title="Mistral"
    href="/aigw/integrations/guardrails/mistral"
  ...
  <Card
    title="Pangea"
    href="/aigw/integrations/guardrails/pangea"
  ...
  <Card
    ...
    href="/aigw/integrations/guardrails/palo-alto-panw-prisma"
  ...
  <Card
    title="Patronus"
    href="/aigw/integrations/guardrails/patronus-ai"
  ...
  <Card
    title="Pillar"
    href="/aigw/integrations/guardrails/pillar"
  ...
  <Card
    ...
    href="/aigw/integrations/guardrails/prompt-security"
  ...
  <Card
    title="Qualifire"
    href="/aigw/integrations/guardrails/qualifire"
  ...
  <Card
    ...
    href="/aigw/integrations/guardrails/crowdstrike-aidr"
  ...
  <Card
    title="Exa"
    href="/aigw/integrations/plugins/exa"
  ...
  <Card
    title="Tavily"
    href="/aigw/integrations/plugins/tavily"
    img="/images/product/Guardrails/tavily.png"
  >
    * Real-time web search grounding for any LLM * Fine-tune freshness, domains,
    answers, raw content, images, and search depth from AI Gateway guardrails
  </Card>
  <Card
    title="F5 Guardrails"
    href="/aigw/integrations/guardrails/f5-guardrails"
  ...
  <Card
    title="Zscaler"
    href="/aigw/integrations/guardrails/zscaler"
  ...
  <Card
    title="Akto"
    href="/aigw/integrations/guardrails/akto"
  >
...
| Guardrail Check | Description | Parameters | Supported On |
| :--- | :--- | :--- | :--- |
| **JWT Token Validator** | [Validate JWT tokens](/aigw/integrations/guardrails/jwt) with signature verification (JWKS), token introspection, claim validation, and extract claims. | *Multiple* | Input only |
| **[Request Parameters Check](/aigw/integrations/guardrails/request-parameters-check)**| Allow/block tools, top-level request keys, and specific parameter values. | `tools`: object, `params`: object | Input only |

#### Routing & Control
| Guardrail Check | Description | Parameters | Supported On |
| :--- | :--- | :--- | :--- |
| **Model Whitelist** | Check if the inference model to be used is in the whitelist. | `Models`: array, `Inverse`: boolean | Input only |
| **[Model Rules](/aigw/integrations/guardrails/model-rules)** | Allow requests based on metadata-driven rules mapping to allowed models. | `rules`: object, `not`: boolean | Input only |
...
We have built Guardrails in a very modular way, and support bringing your own Guardrail using a custom webhook! [Learn more here](/aigw/integrations/guardrails/bring-your-own-guardrails).

## Contribute Your Guardrail

Integrate your Guardrail platform with AI Gateway and reach our growing user base.
