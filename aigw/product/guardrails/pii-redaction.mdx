...
<CardGroup cols={2}>
<Card title="Prisma AIRS AI Gateway Pro PII">
...
<Card title="Pangea" href="/aigw/integrations/guardrails/pangea">
...
For more granular control over PII redaction, you can create custom patterns using the AI Gateway's **Regex Match** guardrail with redaction capabilities. This allows you to define specific patterns for sensitive information unique to your use case.
...
Once you've created your custom PII regex guardrail, add it to your AI Gateway config:
...
This feature can help organisations meet various compliance requirements by:
...
3. Review logs for any error messages or unexpected behaviour
4. For custom regex patterns, validate the regex syntax and test with sample data
5. [Contact us](https://support.portkey.ai/forms/customer-portal-ticket-form) for additional assistance
...
Yes, the feature works with any LLM supported by the AI Gateway.
</Accordion>
