...
Rate Limit is currently only available to **Prisma AIRS AI Gateway** [**Enterprise Plan**](https://portkey.ai/docs/product/enterprise-offering) customers and select Pro users. Email us at `support@portkey.ai` if you would like to enable it for your org.
