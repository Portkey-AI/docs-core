...
*Note: If a specific model is not supported for thinking on the AI Gateway, please reach out to [Portkey support](https://support.portkey.ai/forms/customer-portal-ticket-form).*
