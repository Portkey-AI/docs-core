...
description: "The Prisma AIRS AI Gateway's AI gateway supports text-to-speech models on OpenAI, Azure OpenAI, and Google Vertex AI."
---
...
For detailed documentation including multi-speaker synthesis, style prompts, and all available voices, see [Google Vertex AI Text-to-Speech](/aigw/integrations/llms/vertex-ai/text-to-speech).
