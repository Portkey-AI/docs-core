...
* Through the `x-portkey-config` header on your client (directly or via [frameworks](/aigw/integrations/llms))
...
If you want to attach the configuration to only a few requests instead of modifying the client, you can send it in the `x-portkey-config` request header.
