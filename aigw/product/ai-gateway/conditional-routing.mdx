...
Based on the `conditions` and the Config structure described above, you can create your [Config in Strata Cloud Manager](https://app.portkey.ai/configs), and save it to get Config ID. The UI also helps you autofill and autoformat your Config.
...
1. Create a conditional config in Strata Cloud Manager ([app.portkey.ai/configs](https://app.portkey.ai/configs))
