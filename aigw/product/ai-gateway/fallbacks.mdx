...
Specify a prioritized list of providers/models. If the primary LLM fails, the AI Gateway automatically falls back to the next in line.
...
AI Gateway logs all requests in a fallback chain. To trace:
