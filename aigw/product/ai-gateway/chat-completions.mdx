...
- [Chat Completions](/aigw/api-reference/chat/create-chat-completion) -- `POST /v1/chat/completions`

<CardGroup cols={2}>
  <Card title="OpenAI Chat API Docs" icon="book" href="https://platform.openai.com/docs/api-reference/chat">
    OpenAI specification
  </Card>
  <Card title="API Reference" icon="code" href="/aigw/api-reference/chat/create-chat-completion">
