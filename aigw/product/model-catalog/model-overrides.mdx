...
1.  Navigate to the relevant [**Integration**](https://app.portkey.ai/integrations) in your Strata Cloud Manager account, select the Integration for which you want to add a custom model.
