...
<Note>
**For Organization Admins:** This page is for managing credentials across multiple workspaces. To use AI models in your workspace, see the [Model Catalog](/aigw/product/model-catalog) documentation.
</Note>
