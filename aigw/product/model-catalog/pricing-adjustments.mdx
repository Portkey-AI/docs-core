...
| `additional_units.<key>` | Per-unit charges such as `web_search`, `file_search`, `input_image`, `input_video_standard`. See [Additional Units Reference](/aigw/product/model-catalog/gateway-models#additional-units-reference). |
