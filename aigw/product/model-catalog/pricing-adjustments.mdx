...
description: 'Learn how to apply discount or markup multipliers to a Prisma AIRS AI Gateway Integration so cost tracking reflects your effective rate with a provider.'
---
...
1. Navigate to the relevant [**Integration**](https://app.portkey.ai/integrations) in your Strata Cloud Manager account, and create a new Integration or open an existing one.
