...
## Use with AI Gateway Portkey Models powers automatic cost tracking for all requests through the AI Gateway. When you make requests via the AI Gateway, costs are calculated automatically using this pricing data.
