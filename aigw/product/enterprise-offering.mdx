...
<CardGroup cols={3}>
  ...
  <Card icon="credit-card" title="Budget Limits on Keys">
    Set monthly or custom budget limits on LLM usage, at provider or Prisma AIRS AI Gateway key level.
  </Card>
  <Card icon="folder" title="Org Management">
    Organize your teams and entities with more access control in the AI Gateway.
  </Card>
  ...
  <Card icon="book-bookmark" title="Compliances & Certificates">
    The AI Gateway complies with SOC 2, GDPR, ISO27001, HIPAA to meet the most demanding industry standards.
  </Card>
  <Card icon="handshake" title="Custom BAAs">
    Protect sensitive healthcare data with BAAs tailored to your organisation's requirements.
  </Card>
  <Card icon="lock" title="SSO Integrations">
    The AI Gateway has seamless integrations with your preferred Single Sign-On (SSO) providers like Okta and Microsoft.
  </Card>
  ...
  <Card icon="infinity" title="Unlimited Prompts">
    Create & manage unlimited prompt templates on the AI Gateway.
  </Card>
