...
Metadata in the AI Gateway allows you to attach custom contextual information to your AI requests. Think of it as tagging your requests with important business context that helps you:
...
| Key | Purpose | Notes |
|-----|---------|-------|
| `_user` | User tracking | Powers user-level analytics in Strata Cloud Manager |
...
The Analytics dashboard's [Summary tab](/aigw/product/observability/analytics#summary) lets you group requests by any metadata key to view aggregate stats:
<Frame>
  <img src="/images/metadata.png" alt="Summary tab grouped by a metadata key" />
</Frame>
...
For enterprise users, the AI Gateway offers advanced metadata governance and lets you define metadata at multiple levels:
...
<Card title="Enforcing Required Metadata" href="/aigw/product/administration/enforcing-request-metadata">
...
- Use **consistent keys** across your organisation
