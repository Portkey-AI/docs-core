---
title: "Logs"
description: "The Logs section presents a chronological list of all the requests processed through Prisma AIRS AI Gateway."
---
...
Each log entry provides useful data such as the timestamp, request type, LLM used, tokens generated, thinking tokens and cost. For [multimodal models](/aigw/product/ai-gateway/multimodal-capabilities), Logs will also show the image sent with vision/image models, as well as the image generated.
...
The AI Gateway features—[Cache](/aigw/product/ai-gateway/cache-simple-and-semantic), [Retries](/aigw/product/ai-gateway/automatic-retries), [Fallback](/aigw/product/ai-gateway/fallbacks), [Loadbalance](/aigw/product/ai-gateway/load-balancing) are tracked here with their exact states (`disabled`, `triggered`, etc.), making it a breeze to monitor and optimize your usage.
