...
Portkey’s gateway features—[Cache](/aigw/product/ai-gateway/cache-simple-and-semantic), [Retries](/aigw/product/ai-gateway/automatic-retries), [Fallback](/aigw/product/ai-gateway/fallbacks), [Loadbalance](/aigw/product/ai-gateway/load-balancing) are tracked here with their exact states (`disabled`, `triggered`, etc.), making it a breeze to monitor and optimize your usage.
