...
Tracing also works very well to capture the Gateway behaviour on retries, fallbacks, and other routing mechanisms on AI Gateway.
...
This is especially useful when you want to understand the total latency and behaviour of your app when retry or fallbacks were triggered.
