...
Customize the OAuth client metadata Portkey uses during registration. See [OAuth Client Metadata](/aigw/product/mcp-gateway/authentication/oauth-client-metadata).
...
| Topic | Description |
|-------|-------------|
| [OAuth](/aigw/product/mcp-gateway/authentication/oauth) | Portkey's built-in OAuth 2.1 authentication |
