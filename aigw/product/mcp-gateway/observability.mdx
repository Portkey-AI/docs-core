...
Use [Identity Forwarding](/aigw/product/mcp-gateway/authentication/identity-forwarding) to send user context to MCP servers.

The MCP server receives information about who made the request. It can then:
- Log with Prisma AIRS AI Gateway context
...
For AI Gateway users, MCP logs integrate with existing observability:
