...
The first time a user calls a tool, Prisma AIRS AI Gateway returns an error with an authorization URL. Redirect the user to complete OAuth. After consent, retry the request.
...
For AI Gateway users, MCP integrates automatically:
