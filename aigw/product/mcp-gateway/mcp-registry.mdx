...
<Info>
This section covers how Portkey authenticates to **upstream MCP servers**. For how your agents and MCP clients authenticate to Portkey, see [Gateway Authentication](/aigw/product/mcp-gateway/authentication).
</Info>
