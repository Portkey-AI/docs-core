...
<CardGroup cols={2}>
  <Card
    title="Quickstart"
    icon="rocket"
    href="/aigw/product/agent-gateway/quickstart"
  >
  ...
  <Card
    ...
    icon="code"
    href="/aigw/product/agent-gateway/advanced-code-snippets-and-examples"
  >
...
- [Agent Registry](/aigw/product/agent-gateway/registry): A centralised registry of all agents in your organisation with access control and observability.
- [Agent Servers](/aigw/product/agent-gateway/servers): Agent servers that act as a client to the upstream agent server and as a server to the downstream agent clients.
