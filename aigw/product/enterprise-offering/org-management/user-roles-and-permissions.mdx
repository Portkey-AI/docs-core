...
description: "Learn about Prisma AIRS AI Gateway's comprehensive role-based access control system across Organisations and Workspaces."
---
...
| Manage Organisation Settings | <Icon icon="square-check" iconType="solid" /> | <Icon icon="square-check" iconType="solid" /> | <Icon icon="xmark" iconType="solid" /> |
...
| Invite Organisation Users | <Icon icon="square-check" iconType="solid" /> | <Icon icon="square-check" iconType="solid" /> | <Icon icon="xmark" iconType="solid" /> |
...
|------------|:-----:|:-------:|:------:|
| Invite Organisation Members to Workspace | <Icon icon="square-check" iconType="solid" /> | <Icon icon="square-check" iconType="solid" /> | <Icon icon="xmark" iconType="solid" /> |
...
<CardGroup cols={2}>
  <Card title="Logs Access Permissions" icon="clipboard-list" iconType="solid" href="/aigw/product/administration/configure-logs-access-permissions-in-workspace">
    Control which roles can view, filter, and export logs
  </Card>
  <Card title="Analytics Access Permissions" icon="chart-line" iconType="solid" href="/aigw/product/administration/configure-analytics-access-permissions">
    Control which roles can view analytics dashboards
  </Card>
  <Card title="Providers Access Permissions" icon="key" iconType="solid" href="/aigw/product/model-catalog">
    Manage access to LLM providers for different roles
  </Card>
  <Card title="API Key Permissions" icon="key-skeleton" iconType="solid" href="/aigw/product/administration/configure-api-key-access-permissions">
