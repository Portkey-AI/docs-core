...
If this field is left blank, the dashboard falls back to the AI Gateway's cloud gateway at `https://api.portkey.ai/v1`.
...
If this field is left blank, the dashboard falls back to the AI Gateway's default MCP gateway at `https://mcp.portkey.ai`.
