...
description: Export Prisma AIRS AI Gateway data to OpenTelemetry compatible endpoints for external observability
---
...
<CardGroup cols={2}>
  <Card title="Analytics" icon="chart-bar" href="/aigw/product/enterprise-offering/otel/analytics">
  ...
  <Card title="Complete Logs" icon="file-lines" href="/aigw/product/enterprise-offering/otel/complete-logs">
