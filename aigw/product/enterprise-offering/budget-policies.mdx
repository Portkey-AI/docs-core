...
If you set an **`alert_threshold`**, Portkey records when usage crosses that threshold in **[audit logs](/aigw/product/enterprise-offering/audit-logs)**. Email and other proactive alerts for threshold crossings are **work in progress**; they are not sent today.
