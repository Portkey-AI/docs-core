...
---
## Overview
The Prisma AIRS AI Gateway allows organisation owners to define mandatory [metadata](/aigw/product/observability/metadata) fields that must be included with every API request. This feature enables granular observability across your organisation's LLM usage.
