...
<Card title="AI Gateway Admin API" href="/api-reference/admin-api/control-plane/workspaces/update-workspace">
AI Gateway Workspace API documentation
</Card>

## Availability

Workspace Budget Limits are available to AI Gateway Enterprise customers and select Pro users. To enable these features for your account, please contact [support@portkey.ai](mailto:support@portkey.ai).
