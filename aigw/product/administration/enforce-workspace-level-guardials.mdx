...
## Overview
The Prisma AIRS AI Gateway allows workspace owners to enforce request guardrails at the workspace level. This feature ensures that all API requests made within a workspace comply with predefined policies, enhancing security, compliance, and governance at a more granular level.
...
<Card title="Guardrails Docs" href="/aigw/product/guardrails">
    Learn about the different Guardrails you can set up in the AI Gateway
</Card>

## Configuration
### Setting Up Workspace-Level Guardrails
1. Head to Strata Cloud Manager and navigate to the sidebar.
