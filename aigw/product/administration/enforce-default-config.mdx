...
<Card title="Create API Key" href="/aigw/api-reference/api-keys/post-api-keys-by-sub-type">
  Learn how to create API keys with default configs
</Card>

<Card title="Update API Key" href="/aigw/api-reference/api-keys/put-api-keys-by-id">
...
When using API keys with default configs, the AI Gateway provides flexible options for controlling config behaviour:
