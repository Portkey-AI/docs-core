...
version in `docs.json`, `aigw/overview.mdx` as a scaffold carrying **no product
...
`aigw/_project/`. Anything added here inherits it; anything added elsewhere does not.
