...
## Seeing Cache Results in Prisma AIRS AI Gateway Portkey automatically calculates the correct pricing for your prompt caching requests & responses based on Anthropic's calculations here:
