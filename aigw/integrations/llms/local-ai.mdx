...
| Endpoint | Resource |
| :----------------------------------------------- | :---------------------------------------------------------------- |
| /chat/completions (Chat, Vision, Tools support) | [Doc](/aigw/api-reference/chat/create-chat-completion)              |
| /images/generations                              | [Doc](/aigw/api-reference/images/create-image)          |
| /embeddings                                      | [Doc](/aigw/api-reference/embeddings/create-embedding)                   |
