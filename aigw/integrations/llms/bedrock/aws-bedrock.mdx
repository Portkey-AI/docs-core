...
With Portkey, you can take advantage of features like fast AI gateway access, observability, prompt management, and more, all while ensuring the secure management of your LLM API keys through [Model Catalog](/aigw/product/model-catalog).
...
There are three ways to integrate AWS Bedrock with Portkey:
...
[Check out this example on how you can directly use your AWS details to make a Bedrock request through Portkey.](/aigw/integrations/llms/bedrock/aws-bedrock#making-requests-without-using-portkey%E2%80%99s-model-catalog)
