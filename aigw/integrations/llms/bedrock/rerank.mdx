...
Bedrock supports document reranking through Cohere models. The Prisma AIRS AI Gateway provides a unified `/rerank` endpoint to access this capability.
...
--data '{
    "model": "@BEDROCK_PROVIDER_SLUG/arn:aws:bedrock:us-east-1::foundation-model/cohere.rerank-v3-5:0",
