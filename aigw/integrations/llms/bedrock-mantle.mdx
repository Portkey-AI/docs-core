...
<Note>
Use `bedrock-mantle` when you want OpenAI-compatible access to Bedrock. For the classic Bedrock runtime (Converse / InvokeModel), use the [`bedrock`](/aigw/integrations/llms/bedrock/aws-bedrock) provider.
</Note>
