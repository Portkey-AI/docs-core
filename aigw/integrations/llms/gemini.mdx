...
<Note>
The AI Gateway supports the `system_instructions` parameter for Google Gemini 1.5 - allowing you to control the behaviour and output of your Gemini-powered applications with ease.
...
<Info>
Gemini grounding mode may not work through the AI Gateway. [Contact support](https://support.portkey.ai/forms/customer-portal-ticket-form) for assistance.
</Info>
