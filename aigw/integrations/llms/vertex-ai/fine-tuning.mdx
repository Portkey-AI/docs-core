...
fine_tune_job = openai.fine_tuning.jobs.create(
    model="@VERTEX_PROVIDER/gemini-1.5-pro-002", # Base model to fine-tune
...
curl -X POST --header 'Content-Type: application/json' \
 ...
 --data \
 $'{"model": "@your-vertex-provider/<base_model>", "suffix": "<finetune_name>", "training_file": "gs://<bucket_name>/<file_name>.jsonl", "hyperparameters": {"n_epochs": 2}}\n' \
