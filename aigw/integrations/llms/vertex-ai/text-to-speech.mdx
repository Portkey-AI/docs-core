...
Google Vertex AI offers powerful text-to-speech capabilities through [Gemini TTS models](https://cloud.google.com/text-to-speech/docs/gemini-tts). The Prisma AIRS AI Gateway supports two approaches for TTS:
...
- **Node.js SDK**: Pass additional parameters directly - the AI Gateway SDK accepts arbitrary parameters via its flexible type definitions
</Note>
