---
title: "Azure OpenAI"
description: "Azure OpenAI is a great alternative to accessing the best models including GPT-4 and more in your private environments. The Prisma AIRS AI Gateway provides complete support for Azure OpenAI."
---
...
## AI Gateway SDK Integration with Azure OpenAI
...
Add the AI Gateway SDK to your application to interact with Azure OpenAI's API through the AI Gateway's gateway.
...
Set up the AI Gateway with your Azure Integration as part of the initialization configuration. You can create a [provider](/aigw/product/model-catalog) for Azure in Strata Cloud Manager.
...
2. [Add gateway configs to your Azure OpenAI requests](/aigw/product/ai-gateway/configs)
3. [Tracing Azure OpenAI requests](/aigw/product/observability/traces)
4. [Setup a fallback from OpenAI to Azure OpenAI APIs](/aigw/product/ai-gateway/fallbacks)
