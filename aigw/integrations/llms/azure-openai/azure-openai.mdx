...
Set up Portkey with your Azure Integration as part of the initialization configuration. You can create a [provider](/aigw/product/model-catalog) for Azure in the Portkey UI.
