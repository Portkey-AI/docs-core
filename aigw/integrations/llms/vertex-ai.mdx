...
<Warning>
This flow currently supports **Gemini models only** on Vertex AI. Other Vertex AI models (Anthropic, Llama, Mistral, self-deployed, etc.) are not supported via the Google GenAI SDK — use the AI Gateway SDK or OpenAI-compatible endpoint for those.
</Warning>
