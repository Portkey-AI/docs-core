...
## AI Gateway SDK Integration with OVHcloud AI Endpoints Models
...
Add the AI Gateway SDK to your application to interact with AI Endpoints's API through the AI Gateway's gateway.
