---
title: "Deepgram"
description: Use Deepgram's Speech-to-Text API through Prisma AIRS AI Gateway for audio transcription.
---
...
You can also use Deepgram with the AI Gateway SDK using custom host configuration:
