---
title: 'Dashscope'
description: 'Integrate Dashscope with Prisma AIRS AI Gateway for seamless completions, embeddings, and advanced features.'
---
...
Use the AI Gateway's Gateway features for advanced routing and reliability:
...
<CardGroup cols={2}>
  <Card title="Load Balancing" icon="link" href="/aigw/product/ai-gateway/load-balancing">
...
For the most up-to-date information on supported features and endpoints, please refer to our [API Reference](/aigw/api-reference/inference-api/introduction).
