...
Together AI supports reasoning models that expose their internal chain of thought. Use the `reasoning_effort` parameter to control reasoning behaviour, and set `strict_open_ai_compliance=False` to receive the thinking content in `content_blocks`.
