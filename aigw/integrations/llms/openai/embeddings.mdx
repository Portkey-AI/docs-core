---
title: "Embeddings"
description: "Generate vector embeddings from text using OpenAI's embedding models through Prisma AIRS AI Gateway."
---
...
response = client.embeddings.create(
    input="Your text string goes here",
    model="@OPENAI_PROVIDER/text-embedding-3-small"
)
