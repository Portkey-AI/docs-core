...
Portkey supports the [Responses API](/aigw/product/ai-gateway/responses-api) on Azure AI Foundry in **two modes**. Pick the one that matches your Azure deployment.
