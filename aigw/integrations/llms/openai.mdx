...
The AI Gateway captures the information about the request on Strata Cloud Manager. On your logs screen, you'd be able to see this request with the request and response.
