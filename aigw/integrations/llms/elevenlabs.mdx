---
title: "ElevenLabs"
description: Use ElevenLabs' text-to-speech, speech-to-text, and voice cloning APIs through Prisma AIRS AI Gateway.
---
...
## Using with AI Gateway SDK

You can also use ElevenLabs with the AI Gateway SDK using custom host configuration:
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Host Setup" icon="server" href="/aigw/product/ai-gateway/universal-api#integrating-local-or-private-models">
