...
<Note>
The AI Gateway handles all authentication and header translation automatically. From your client, the experience is identical to using first-party Anthropic -- just use a different provider slug.
</Note>
