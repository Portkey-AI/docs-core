...
Improve performance and reduce costs on your Agent's LLM calls by storing past responses in the AI Gateway cache. Choose between Simple and Semantic cache modes in your AI Gateway's gateway config.
