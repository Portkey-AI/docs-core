...
# Configure OpenTelemetry export to the AI Gateway
...
### Step 3: Complete Setup - Use the AI Gateway

For the best experience, route your LLM calls through the AI Gateway to get automatic optimizations:
