...
<Card title="Organization Management" icon="building" href="/aigw/product/enterprise-offering/org-management">
...
<CardGroup cols={2}>
<Card title="Explore Portkey Features" icon="rocket" href="/aigw/product/ai-gateway">
