...
Once configured, navigate to the [Strata Cloud Manager](https://app.portkey.ai/logs) to see your Traceloop instrumentation combined with gateway intelligence:
