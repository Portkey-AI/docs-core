---
title: "HoneyHive"
description: "Integrate HoneyHive observability with Prisma AIRS AI Gateway's AI gateway for comprehensive LLM monitoring and advanced routing capabilities"
---
...
HoneyHive is a comprehensive AI observability platform that helps you monitor, evaluate, and improve your LLM applications. When combined with the AI Gateway, you get powerful observability features alongside the AI Gateway's advanced AI gateway capabilities.

This integration allows you to:
- Automatically trace all LLM requests through the AI Gateway
- Use the AI Gateway's 3,000+ LLMs with HoneyHive observability
...
HoneyHive automatically traces requests to popular LLM providers, making the integration with the AI Gateway seamless. Simply initialize HoneyHive and point your LLM clients to the AI Gateway.
...
# Create OpenAI client pointing to the AI Gateway
client = OpenAI(
...
## Using AI Gateway Features with HoneyHive
...
Switch between 3,000+ LLMs while maintaining HoneyHive observability:
...
Use the AI Gateway's config system for advanced features while tracking in HoneyHive:

```python
@trace
def advanced_llm_call():
    # Reference a saved config from Strata Cloud Manager
    client = OpenAI(
        api_key="YOUR_PORTKEY_API_KEY",
        base_url="https://aigw.portkey.ai/v1"
    )
...
Add custom metadata visible in both HoneyHive and the AI Gateway:
...
If you're already using HoneyHive with OpenAI, migrating to use the AI Gateway is simple:
