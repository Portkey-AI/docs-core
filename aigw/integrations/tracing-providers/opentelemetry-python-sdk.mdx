...
Once configured, navigate to the [Strata Cloud Manager](https://app.portkey.ai/logs) to see your custom OpenTelemetry traces enhanced with gateway intelligence:
