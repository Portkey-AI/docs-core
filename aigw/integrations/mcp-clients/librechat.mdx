---
title: LibreChat
description: Connect your MCP servers to LibreChat through Prisma AIRS AI Gateway's secure MCP gateway
---

## Overview

LibreChat is an open-source AI chat platform that supports MCP (Model Context Protocol) for enhanced tool integration. Through the AI Gateway's MCP Gateway, you can seamlessly connect any MCP server to LibreChat without managing infrastructure or authentication.
...
1. **First Connection**: When LibreChat first connects to an authenticated MCP server, the AI Gateway will:
...
mcpServers:
  ...
  slack:
    type: "streamable-http"
    url: "https://aigw.portkey.ai/m/ws-abc123/slack-jkl012/mcp"
```
