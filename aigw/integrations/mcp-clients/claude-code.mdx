---
title: Claude Code
description: Connect your MCP servers to Claude Code CLI through Prisma AIRS AI Gateway's secure MCP gateway
---
...
```bash
claude mcp add --transport http portkey-mcp https://aigw.portkey.ai/m/:workspace-id/:server-id/mcp
```
...
claude mcp add --transport http linear https://aigw.portkey.ai/m/ws-abc123/linear-def456/mcp
```
...
# Add GitHub
claude mcp add --transport http github https://aigw.portkey.ai/m/ws-abc123/github-ghi789/mcp

# Add Slack
claude mcp add --transport http slack https://aigw.portkey.ai/m/ws-abc123/slack-jkl012/mcp
```

### With Custom Headers (if needed)

```bash
claude mcp add --transport http secure-api https://aigw.portkey.ai/m/ws-abc123/api-xyz789/mcp \
