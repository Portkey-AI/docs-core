...
description: "Integrate Microsoft Azure's powerful content moderation services & PII guardrails with Prisma AIRS AI Gateway"
---

Microsoft Azure offers robust content moderation and PII redaction services that can now be seamlessly integrated with the AI Gateway's guardrails ecosystem. This integration supports four powerful Azure services:
...
Follow these steps to integrate Azure's content moderation services with the AI Gateway:
...
Once authentication is set up, you can add Azure guardrail checks to your AI Gateway workflow:
...
| PII Categories | Restrict detection to specific entity types. Leave empty to detect all default categories. | e.g. `Person`, `Email`, `PhoneNumber`, `Address`, `CreditCardNumber`, `PassportNumber` |
...
All guardrail actions and verdicts are visible in your AI Gateway logs, allowing you to:
...
- Monitor the guardrail results in your AI Gateway logs
