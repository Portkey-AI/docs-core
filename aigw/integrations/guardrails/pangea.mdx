...
## Using Pangea with Prisma AIRS AI Gateway

### 1. Add Pangea Credentials to the AI Gateway
...
Your requests are now guarded by Pangea AI Guard and you can see the Verdict and any action you take directly on AI Gateway logs! More detailed logs for your requests will also be available on your Pangea dashboard.

---

## Using Raw Guardrails with Pangea

You can define Pangea guardrails directly in your code for more programmatic control without using Strata Cloud Manager. This "raw guardrails" approach lets you dynamically configure guardrails based on your application's needs.
