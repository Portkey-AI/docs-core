...
The JWT Token Validator guardrail provides comprehensive JWT (JSON Web Token) validation and authentication for Prisma AIRS AI Gateway. It supports signature verification, claim validation, and custom business logic rules.
...
- **Multi-tenant Support**: Validate tenant IDs and other organisational claims
