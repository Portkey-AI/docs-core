...
- Add it to `input_guardrails` in a [Portkey Config](/aigw/product/ai-gateway/configs)
...
- Attach it as an [Org Guardrail](/aigw/product/guardrails) so it applies across the entire organization
