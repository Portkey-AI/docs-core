...
<Note>
Guardrail Actions let you orchestrate your guardrail's behaviour (deny, feedback, etc.). Learn more about them [here](/aigw/product/guardrails#there-are-7-types-of-guardrail-actions).
</Note>
