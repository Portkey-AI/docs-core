...
## Using Cato with Prisma AIRS AI Gateway

### 1. Add Cato Credentials to the AI Gateway
...
See [Configs](/aigw/product/ai-gateway/configs) for usage with SDKs and the gateway.
