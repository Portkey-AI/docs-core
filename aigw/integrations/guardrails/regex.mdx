...
description: "Redact custom patterns with Regex in Prisma AIRS AI Gateway."
---

For more granular control over pattern redaction, you can create custom patterns using the AI Gateway's **Regex Match** guardrail with redaction capabilities. This allows you to define specific regex patterns for sensitive information unique to your use case.
...
Once you've created your custom regex pattern guardrail, add it to your AI Gateway config:
