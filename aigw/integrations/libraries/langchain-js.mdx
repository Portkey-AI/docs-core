...
<Info>
This guide covers Langchain **JavaScript/TypeScript**. For Python, see [Langchain Python](/aigw/integrations/libraries/langchain-python).
</Info>
...
const model = new ChatOpenAI({
    ...
    apiKey: "PORTKEY_API_KEY"               // Your AI Gateway API key
});
...
const openaiModel = new ChatOpenAI({
    model: "@openai-prod/gpt-4o",
    configuration: { baseURL: "https://aigw.portkey.ai/v1" },
    apiKey: "PORTKEY_API_KEY"
});
...
Langchain agents are the primary use case. The AI Gateway works seamlessly with agent workflows:
...
// Create model with the AI Gateway
const model = new ChatOpenAI({
    model: "@openai-prod/gpt-4o",
    configuration: { baseURL: "https://aigw.portkey.ai/v1" },
    apiKey: "PORTKEY_API_KEY"
...
const model = new ChatOpenAI({
    ...
    configuration: {
        baseURL: "https://aigw.portkey.ai/v1"     // Add this
    },
    apiKey: "PORTKEY_API_KEY",                // Change to AI Gateway API key
