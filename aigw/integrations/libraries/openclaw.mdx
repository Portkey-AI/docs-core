...
Run `openclaw` and make a request. Open the [Strata Cloud Manager](https://app.portkey.ai) — you should see your request logged with cost, latency, and the full payload.
...
Create configs in [AI Gateway Configs](https://app.portkey.ai/configs) and attach them to your API key.
