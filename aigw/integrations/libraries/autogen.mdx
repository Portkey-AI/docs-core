...
<Card title="This Integration is DEPRECATED" icon="robot" href="/aigw/integrations/agents/autogen">
...
Since the AI Gateway [seamlessly connects to 3,000+ models across providers](/aigw/integrations/llms), you can easily connect any of these to now run with Autogen.
...
config_list = [
    {
        ...
        "default_headers": {"x-portkey-provider": "anyscale"}
    }
]
...
[Model Catalog](/aigw/product/model-catalog) in the AI Gateway lets you manage provider credentials centrally. Add your Anyscale API key to Model Catalog and use the AI Provider slug in your config.


## Using Configs

[Configs](/aigw/product/ai-gateway/configs) in the AI Gateway unlock advanced management and routing functionality including [load balancing](/aigw/product/ai-gateway/load-balancing), [fallbacks](/aigw/product/ai-gateway/fallbacks), [canary testing](/aigw/product/ai-gateway/canary-testing), [switching models](/aigw/product/ai-gateway/universal-api) and more.
