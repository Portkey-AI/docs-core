...
Cline is an AI coding assistant for VS Code. Add Prisma AIRS AI Gateway to get:
...
This guide shows how to configure Cline with the AI Gateway in under 5 minutes.
...
<Note>
**Want fallbacks, load balancing, or caching?** Create a [AI Gateway Config](/aigw/product/ai-gateway/configs), attach it to your API key, and set Model ID to `dummy`. See [Enterprise Governance](#3-enterprise-governance) for examples.
</Note>
