...
To bypass this filtering and pass `anthropic-beta` through unchanged, add `"forward_headers": ["anthropic-beta"]` to your [Portkey Config](/aigw/product/ai-gateway/configs).
</Info>
