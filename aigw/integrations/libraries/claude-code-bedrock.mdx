...
That's it! All Claude Code requests now route through Bedrock via the AI Gateway. Monitor usage in the [Strata Cloud Manager](https://app.portkey.ai/logs).
...
1. Go to [Model Catalog](https://app.portkey.ai/model-catalog) → Select your Bedrock integration
2. Click **Set Now**
3. Configure:
