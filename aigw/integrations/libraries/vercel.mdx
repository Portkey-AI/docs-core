...
[Sign up for the AI Gateway](https://app.portkey.ai) and copy your API key from the dashboard. You'll use this to authenticate with the AI Gateway's gateway.
...
1. Go to the [Model Catalog](https://app.portkey.ai) in Strata Cloud Manager
