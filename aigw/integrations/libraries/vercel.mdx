...
const openai = createOpenAI({
  ...
  apiKey: 'YOUR_PORTKEY_API_KEY', // Your AI Gateway API key
});
```
...
Fine-tune model behaviour with temperature, tokens, and retries:
...
<Card title="Learn more about AI Gateway Headers" href="/aigw/api-reference/inference-api/headers" />
...
AI Gateway Configs enable advanced routing, reliability, and governance for your AI requests. You can apply configs in two ways:
...
<Frame>
  <img src="/images/product/dashboard.png" alt="The AI Gateway analytics dashboard" />
</Frame>
