---
title: 'Vercel AI SDK'
description: 'Use Prisma AIRS AI Gateway with Vercel AI SDK to build production-ready AI apps with full observability, reliability, and 250+ model support'
---

The AI Gateway seamlessly integrates with the Vercel AI SDK, enabling you to build production-ready AI applications with enterprise-grade reliability, observability, and governance. Simply point the OpenAI provider to the AI Gateway's gateway and unlock powerful features:
...
[Sign up for the AI Gateway](https://stratacloudmanager.paloaltonetworks.com/) and copy your API key from the dashboard. You'll use this to authenticate with the AI Gateway's gateway.

### 3. Configure the OpenAI Provider

Point the OpenAI provider to the AI Gateway's gateway:
...
- Set `baseURL` to the AI Gateway's gateway
