...
<Note>
**Want fallbacks, load balancing, or caching?** Create a [Portkey Config](/aigw/product/ai-gateway/configs), attach it to your API key, and set model name to `dummy`. See [Enterprise Governance](#3-enterprise-governance) for examples.
</Note>
