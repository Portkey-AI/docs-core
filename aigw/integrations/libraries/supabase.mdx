...
Supabase provides Postgres with pgvector for AI applications. With the AI Gateway, generate embeddings using 1600+ models and store them in Supabase for efficient retrieval.
