...
description: 'Route Claude Code through Anthropic Direct API via Portkey for observability, governance, and reliability'
---
...
See [Claude Code overview](/aigw/integrations/libraries/claude-code) for why platform teams use Portkey.
...
Some Claude Code features require the `anthropic-beta` header. Configure this in a [Portkey Config](/aigw/product/ai-gateway/configs):
