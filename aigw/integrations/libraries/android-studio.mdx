...
Go to [API Keys](https://app.portkey.ai/api-keys) and create a Portkey API key. Optionally attach a [Config](/aigw/product/ai-gateway/configs) for fallbacks, load balancing, or caching.
</Step>
</Steps>
...
<Note>
**Fallbacks, load balancing, or caching?** Create a [Portkey Config](/aigw/product/ai-gateway/configs), attach it to your API key, and use the config’s virtual model in Android Studio. See [Enterprise Governance](#3-enterprise-governance) for examples.
</Note>
