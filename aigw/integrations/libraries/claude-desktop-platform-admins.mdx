...
<CardGroup cols={3}>
  <Card title="Budget Limits" icon="coins" href="/aigw/product/model-catalog/budget-limits">
    Cap spend by team, environment, or individual user.
  </Card>
  <Card title="Rate Limits" icon="gauge-high" href="/aigw/product/model-catalog/rate-limits">
