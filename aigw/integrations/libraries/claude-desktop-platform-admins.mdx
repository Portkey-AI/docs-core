...
<Steps>
  <Step title="Requests appear in Logs with correct metadata">
    Send a test request from Claude Desktop. Confirm it shows up in [AI Gateway Logs](https://app.portkey.ai/logs) with all the metadata fields you defined in step 5.
  </Step>
