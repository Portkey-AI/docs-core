...
<CardGroup cols={3}>
  <Card title="Gateway URL" icon="globe">
    `https://api.portkey.ai` for AI Gateway SaaS, or your custom URL if your org self-hosts. Confirm with your admin.
  </Card>
...
<Steps>
  <Step title="Confirm the request reached the AI Gateway">
    Open [AI Gateway Logs](https://app.portkey.ai/logs). Your request should appear within a few seconds, tagged with the metadata you set in step 4.
...
<AccordionGroup>
  <Accordion title="Why am I getting a 401 or 403 error?" icon="lock">
    Your AI Gateway API key is expired, revoked, or scoped to a different workspace. Get a fresh key from your admin or generate one yourself at [API Keys](https://app.portkey.ai/api-keys).
  </Accordion>

  <Accordion title="Why aren't my requests appearing in Logs?" icon="eye-slash">
    Three things to check:

    1. Base URL is correct: `https://api.portkey.ai` for AI Gateway SaaS, or your org's self-hosted gateway URL. No trailing slash, no `/v1`.
