...
Add the AI Gateway SDK to your application to interact with Qdrant through the AI Gateway's gateway.
...
You will also need your AI Gateway API Key from [the AI Gateway's Dashboard](https://app.portkey.ai).
