...
* **Workspace organisation** — Understand nested page structure and database relationships.
...
3. Add the MCP server config to your client (Claude Desktop, VS Code, Prisma AIRS AI Gateway).
