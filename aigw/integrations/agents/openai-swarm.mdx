...
- **AI Gateway API Key**: Sign up on the [Strata Cloud Manager](https://app.portkey.ai) and copy your API key.
...
Configure these settings in the [Strata Cloud Manager](https://app.portkey.ai) or programmatically through the API.
