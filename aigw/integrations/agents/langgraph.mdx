---
title: "LangGraph"
description: "Use Prisma AIRS AI Gateway with LangGraph to take your AI agent workflows to production"
---
...
Create an AI Gateway API key with optional budget/rate limits from the [Strata Cloud Manager](https://app.portkey.ai/). You can attach configurations for reliability, caching, and more to this key.
</Step>
...
<AccordionGroup>
  <Accordion title="How does the AI Gateway enhance LangGraph?">
    the AI Gateway adds production-readiness to LangGraph through comprehensive observability (traces, logs, metrics), reliability features (fallbacks, retries, caching), and access to 1600+ LLMs through a unified interface. This makes it easier to debug, optimize, and scale your agent workflows.
  </Accordion>
...
<CardGroup cols="3">
  ...
  <Card title="AI Gateway Docs" icon="book" href="https://portkey.ai/docs">
