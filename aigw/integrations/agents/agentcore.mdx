...
| --- | --- | --- |
| Entire AgentCore app should use Portkey | Register a global Portkey client (as shown above) so every LLM call flows through Portkey | Works with all frameworks—see [Strands](/aigw/integrations/agents/strands), [LangGraph](/aigw/integrations/agents/langgraph), [OpenAI Agents](/aigw/integrations/agents/openai-agents) |
