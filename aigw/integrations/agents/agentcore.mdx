...
1. **Add your AI provider keys**
   Go to [Model Catalog Keys](https://app.portkey.ai/model-catalog) in Strata Cloud Manager and add your actual AI provider keys (OpenAI, Anthropic, AWS Bedrock, etc.). Each provider key gets a unique slug that you'll reference in configs.
...
All LLM traffic from your agent now flows through the AI Gateway, giving you observability, reliability, and multi-provider routing. Check the [Strata Cloud Manager](https://app.portkey.ai/logs) to see traces, costs, and performance metrics.
  </Step>
</Steps>
...
1. Monitor test invocations in the [Strata Cloud Manager](https://app.portkey.ai/logs) to validate tracing, metadata, and costs
