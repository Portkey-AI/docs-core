...
description: "Use Prisma AIRS AI Gateway with Claude Agent SDK for production-ready AI agents with observability and governance"
---
...
<Step title="Add Provider in the AI Gateway">
...
```bash
export ANTHROPIC_BASE_URL="https://aigw.portkey.ai"
export ANTHROPIC_AUTH_TOKEN="dummy"
export ANTHROPIC_CUSTOM_HEADERS="Authorization: Bearer YOUR_PORTKEY_API_KEY
...
# Set environment variables for the AI Gateway
os.environ["ANTHROPIC_BASE_URL"] = "https://aigw.portkey.ai"
os.environ["ANTHROPIC_AUTH_TOKEN"] = "dummy"
os.environ["ANTHROPIC_CUSTOM_HEADERS"] = """Authorization: Bearer YOUR_PORTKEY_API_KEY
x-portkey-provider: @anthropic-prod"""
...
os.environ["ANTHROPIC_BASE_URL"] = "https://aigw.portkey.ai"
os.environ["ANTHROPIC_AUTH_TOKEN"] = "dummy"
os.environ["ANTHROPIC_CUSTOM_HEADERS"] = """Authorization: Bearer YOUR_PORTKEY_API_KEY x-portkey-provider: @anthropic-prod"""
...
os.environ["ANTHROPIC_CUSTOM_HEADERS"] = f"""Authorization: Bearer YOUR_PORTKEY_API_KEY
x-portkey-provider: @anthropic-prod
...
For advanced routing, fallbacks, and caching, create a [AI Gateway Config](/aigw/product/ai-gateway/configs) and reference it:
...
Create a config in the [Strata Cloud Manager](https://stratacloudmanager.paloaltonetworks.com/) with fallback logic:
