...
<Note>
**Realtime API support is coming soon!** Reach out to [Portkey support](https://support.portkey.ai/forms/customer-portal-ticket-form) to be the first to know when LiveKit's realtime model integration with the AI Gateway is available.
</Note>
