...
That's all you need to do to use Prisma AIRS AI Gateway with Langchain agents. Execute your agents and visit the [Strata Cloud Manager](https://stratacloudmanager.paloaltonetworks.com/) to observe your Agent's activity.
...
The AI Gateway makes your Langchain agents reliable, robust, and production-grade with its observability suite. Seamlessly integrate 3,000+ LLMs with your Langchain agents, implement fallbacks, gain granular insights into agent performance and costs, and continuously optimize your AI operations—all with just 2 lines of code.
