...
The AI Gateway provides comprehensive visibility into your agent's behaviour without requiring any code changes.
...
Configure different behaviour for development, staging, and production:
...
1. **Monitor your agents** in the [Strata Cloud Manager](https://stratacloudmanager.paloaltonetworks.com/) to understand their behaviour
