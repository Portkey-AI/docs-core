...
One of the AI Gateway's key strengths is providing access to 1600+ LLMs through a unified interface. Here's how to use different providers with Autogen:
...
The AI Gateway allows you to use 1600+ LLMs with your Autogen setup, with minimal configuration required. Let's set up the core components in the AI Gateway that you'll need for integration.
...
Create your config on the [Configs page](https://app.portkey.ai/configs) in Strata Cloud Manager. You'll need the config ID for connecting to your Autogen setup.
...
The AI Gateway adds production-grade features to Autogen agents including comprehensive observability (traces, logs, analytics), reliability (fallbacks, retries, load balancing), access to 1600+ LLMs, cost management, and enterprise governance - all without changing your agent logic.
</Accordion>
