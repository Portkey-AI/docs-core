---
title: "Control Flow"
description: "Use Prisma AIRS AI Gateway with Control Flow to take your AI Agents to production"
---
...
Here's a simple Google Colab notebook that demonstrates Control Flow with AI Gateway integration

[![](/images/guides/colab-badge.svg)](https://dub.sh/Control-Flow-docs)

## Make your agents Production-ready with AI Gateway

The AI Gateway makes your Control Flow agents reliable, robust, and production-grade with its observability suite. Seamlessly integrate 3,000+ LLMs with your Control Flow agents, implement fallbacks, gain granular insights into agent performance and costs, and continuously optimize your AI operations—all with just 2 lines of code.
