...
See [OAuth Client Metadata](/product/mcp-gateway/authentication/oauth-client-metadata#example-provider-specific-authorization-parameters-google) for details.
