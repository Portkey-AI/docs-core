---
title: "Introduction"
description: "This documentation provides detailed information about the various ways you can access and interact with Portkey - **a robust AI gateway** designed to simplify and enhance your experience with Large Language Models (LLMs) like OpenAI's GPT models. "
---
...
Learn more [here](/docs/api-reference/portkey-sdk-client).
...
Learn more [here](/docs/integrations/llms/openai).

### 3\. REST API

**Ideal for:** applications that prefer RESTful services. The base URL for all REST API requests is `https://api.portkey.ai/v1`, with an [authentication](/docs/api-reference/authentication) header.

Learn more [here](/docs/provider-endpoints/chat).
