...
```
  ...
  <Tab title="REST API">
    ...
    * [Add the relevant headers](/docs/api-reference/portkey-sdk-client#rest-headers) to enable the AI gateway features.
  </Tab>
  <Tab title="Other SDKs">
    ...
    2. [Add the relevant headers](/docs/api-reference/portkey-sdk-client#rest-headers) to enable the AI gateway features.
  </Tab>
</Tabs>
...
### [OpenAI Chat Completion](/docs/provider-endpoints/completions)
...
If you want to see all the providers Portkey works with, check out the [list of providers](https://docs.portkey.ai/providers/supported-providers)[.](/docs/guides/integrations)

### [OpenAI Embeddings](/docs/provider-endpoints/embeddings)
...
### [OpenAI Function Calling](/docs/product/ai-gateway/multimodal-capabilities/function-calling)
...
### [OpenAI Chat-Vision](/docs/product/ai-gateway/multimodal-capabilities/vision)
...
### [Images](/docs/provider-endpoints/images)
...
### [OpenAI Audio](/docs/provider-endpoints/audio)
...
### [OpenAI Batch - Create Batch](/docs/provider-endpoints/batch)
...
### [Files - Upload File](/docs/provider-endpoints/files)
