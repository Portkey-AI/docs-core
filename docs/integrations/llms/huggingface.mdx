...
2. [Add gateway configs to your Huggingface requests](/docs/product/ai-gateway/configs)[ requests](/docs/product/ai-gateway/configs)
3. [Tracing Huggingface requests](/docs/product/observability/traces)
4. [Setup a fallback from OpenAI to Huggingface APIs](/docs/product/ai-gateway/fallbacks)
