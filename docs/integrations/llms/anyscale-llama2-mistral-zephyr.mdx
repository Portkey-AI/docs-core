...
<Tabs>
  ...
  <Tab title="REST API">
    ...
    [List of all possible Portkey headers](/docs/api-reference/portkey-sdk-client#parameters).
...
You can manage all prompts for Anyscale's OSS models in the [Prompt Library](/docs/product/prompt-library). All the current models of Anyscale are supported.
...
| Model Name                                                                                                                  | Model Key on Portkey                |
| --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| [Llama 2 - 7B](https://d3qavlo5goipcw.cloudfront.net/supported-models/meta-llama-Llama-2-7b-chat-hf/)                       | meta-llama/Llama-2-7b-chat-hf       |
| [Llama 2- 13B](https://d3qavlo5goipcw.cloudfront.net/supported-models/meta-llama-Llama-2-13b-chat-hf/)                      | meta-llama/Llama-2-13b-chat-hf      |
| [Llama 2 - 70B](https://d3qavlo5goipcw.cloudfront.net/supported-models/meta-llama-Llama-2-70b-chat-hf/)                     | meta-llama/Llama-2-70b-chat-hf      |
| [Code Llama - 34B](https://d3qavlo5goipcw.cloudfront.net/supported-models/codellama-CodeLlama-34b-Instruct-hf/)             | codellama/CodeLlama-34b-Instruct-hf |
| [Mistral - 7B](https://d3qavlo5goipcw.cloudfront.net/supported-models/mistralai-Mistral-7B-Instruct-v0.1/)                  | mistralai/Mistral-7B-Instruct-v0.1  |
| [HF Zephyr - 7B (Based on Mistral-7B)](https://d3qavlo5goipcw.cloudfront.net/supported-models/huggingfaceh4-zephyr-7b-beta) | HuggingFaceH4/zephyr-7b-beta        |
...
2. [Add gateway configs to the client or a single request](/docs/product/ai-gateway/configs)
3. [Trace Anyscale requests](/docs/product/observability/traces)
