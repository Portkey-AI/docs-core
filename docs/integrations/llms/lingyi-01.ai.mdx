...
You can manage all prompts to Lingyi in the [Prompt Library](/docs/product/prompt-library). All the current models of Lingyi are supported and you can easily start testing different prompts.
...
2. [Add gateway configs to your Lingyi requests](/docs/product/ai-gateway/configs)
3. [Tracing Lingyi requests](/docs/product/observability/traces)
4. [Setup a fallback from OpenAI to Lingyi APIs](/docs/product/ai-gateway/fallbacks)
