...
You can manage all prompts to MonsterAPI in the [Prompt Library](/docs/product/prompt-library). All the current models of MonsterAPI are supported and you can easily start testing different prompts.
...
2. [Add gateway configs to your MonsterAPI requests](/docs/product/ai-gateway/configs)
3. [Tracing MonsterAPI requests](/docs/product/observability/traces)
4. [Setup a fallback from OpenAI to MonsterAPI APIs](/docs/product/ai-gateway/fallbacks)
