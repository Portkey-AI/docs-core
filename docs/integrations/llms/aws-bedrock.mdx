...
[Here's a guide on where to find your AWS credentials on AWS](/docs/integrations/llms/aws-bedrock#how-to-find-your-aws-credentials).
...
[Check out this example on how you can directly use your AWS details to make a Bedrock request through Portkey.](/docs/integrations/llms/aws-bedrock#making-requests-without-virtual-keys)
...
You can manage all prompts to AWS bedrock in the [Prompt Library](/docs/product/prompt-library). All the current models of Anthropic are supported and you can easily start testing different prompts.
...
2. [Add gateway configs to your Bedrock requests](/docs/product/ai-gateway/configs)
3. [Tracing Bedrock requests](/docs/product/observability/traces)
4. [Setup a fallback from OpenAI to Beckrock APIs](/docs/product/ai-gateway/fallbacks)
