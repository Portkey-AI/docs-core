...
<Accordion title="Supported Endpoints">
  1. jkabf
  2. adsf
  3. adsfg
</Accordion>

  <Accordion title="Unsupported Endpoints">
  1. jkabf
  2. adsf
  3. adsfg
</Accordion>
...
|Portkey Features| Logs | Traces | Feedback | Custom Metadata | Filters | Alerts | Universal API | Automatic Fallbacks | Loadbalancing | Automatic Retries | Request Timeouts | Config Management | Virtual Keys | Caching | Prompt Templates | Guardrails | Autonomous Fine-Tuning |
|---|------|--------|----------|-----------------|---------|--------|----------------|---------------------|---------------|-------------------|------------------|-------------------|--------------|---------|------------------|------------|------------------------|
|openai| <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> | <Icon icon="square-check" color="#23e605" /> |



### Supported Features for OpenAI

- **Logs**: <Icon icon="square-check" color="#23e605" />
- **Traces**: <Icon icon="square-check" color="#23e605" />
- **Feedback**: <Icon icon="square-check" color="#23e605" />
- **Custom Metadata**: <Icon icon="square-check" color="#23e605" />
- **Filters**: <Icon icon="square-check" color="#23e605" />
...
| **Custom Metadata**         | <Icon icon="square-check" color="#23e605" /> |
| **Filters**                | <Icon icon="square-check" color="#23e605" /> |
| **Alerts**                 | <Icon icon="square-check" color="#23e605" /> |
| **Universal API**          | <Icon icon="square-check" color="#23e605" /> |
| **Automatic Fallbacks**     | <Icon icon="square-check" color="#23e605" /> |
| **Load Balancing**          | <Icon icon="square-check" color="#23e605" /> |
| **Automatic Retries**       | <Icon icon="square-check" color="#23e605" /> |
| **Request Timeouts**        | <Icon icon="square-check" color="#23e605" /> |
| **Config Management**       | <Icon icon="square-check" color="#23e605" /> |
| **Virtual Keys**            | <Icon icon="square-check" color="#23e605" /> |
| **Caching**                | <Icon icon="square-check" color="#23e605" /> |
| **Prompt Templates**        | <Icon icon="square-check" color="#23e605" /> |
| **Guardrails**             | <Icon icon="square-check" color="#23e605" /> |
| **Autonomous Fine-Tuning**  | <Icon icon="square-check" color="#23e605" /> |
