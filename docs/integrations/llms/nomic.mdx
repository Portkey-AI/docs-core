...
1. [API Reference for Embeddings](/docs/provider-endpoints/embeddings)
2. [Add metadata to your requests](/docs/product/observability/metadata)
3. [Add gateway configs to your Nomic requests](/docs/product/ai-gateway/configs)
4. [Tracing Nomic requests](/docs/product/observability/traces)
