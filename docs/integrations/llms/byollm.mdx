...
More on `custom_host` [here](/docs/product/ai-gateway/universal-api#integrating-local-or-private-models).
...
2. [Add gateway configs to your requests](/docs/product/ai-gateway/universal-api#ollama-in-configs)
3. [Tracing requests](/docs/product/observability/traces)
4. [Setup a fallback from OpenAI to your local LLM](/docs/product/ai-gateway/fallbacks)