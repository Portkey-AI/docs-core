...
2. Next, insert the Portkey-specific code as shown in the highlighted lines to your OpenAI function calls. `PORTKEY_GATEWAY_URL` is portkey's gateway URL to route your requests and `createHeaders` is a convenience function that generates the headers object. ([All supported params/headers](/docs/api-reference/portkey-sdk-client#python-3))
...
[List of all possible headers](/docs/api-reference/portkey-sdk-client#rest-headers)
...
<Card
  title="Metadata"
  href="/docs/product/observability/metadata"
/>
<Note>
...
* If you are looking for a way to add your **Org ID** & **Project ID** to the requests, head over to [this section](/docs/integrations/llms/openai#managing-openai-projects-and-organizations-in-portkey).

</Note>

## Using the Prompts API

Portkey also supports creating and managing prompt templates in the [prompt library](/docs/product/prompt-library). This enables the collaborative development of prompts directly through the user interface.
...
Please refer to our fine-tuning guides to take advantage of Portkey's advanced [continuous fine-tuning](/docs/product/autonomous-fine-tuning) capabilities.
...
<Info>
[Text-to-Speech](/docs/product/ai-gateway/multimodal-capabilities/vision-2)
</Info>
<Info>
[Speech-to-Text](/docs/product/ai-gateway/multimodal-capabilities/vision-1)
</Info>
---
...
<Info>
[Virtual Keys](/docs/product/ai-gateway/virtual-keys)
</Info>
...
2. [Add gateway configs to the OpenAI client or a single request](/docs/product/ai-gateway/configs)
3. [Tracing OpenAI requests](/docs/product/observability/traces)
4. [Setup a fallback to Azure OpenAI](/docs/product/ai-gateway/fallbacks)
