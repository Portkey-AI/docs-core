...
2. [Add gateway configs to your ZhipuAI requests](/docs/product/ai-gateway/configs)
3. [Tracing ZhipuAI requests](/docs/product/observability/traces)
4. [Setup a fallback from OpenAI to ZhipuAI](/docs/product/ai-gateway/fallbacks)
