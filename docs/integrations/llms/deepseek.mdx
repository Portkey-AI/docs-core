...
You can manage all prompts to DeepSeek in the [Prompt Library](/docs/product/prompt-library). All the current models of DeepSeek are supported and you can easily start testing different prompts.
...
2. [Add gateway configs to your DeepSeek requests](/docs/product/ai-gateway/configs)
3. [Tracing DeepSeek requests](/docs/product/observability/traces)
4. [Setup a fallback from OpenAI to DeepSeek APIs](/docs/product/ai-gateway/fallbacks)
