---
title: "Vercel"
description: "Portkey natively integrates with your Vercel AI app. In this guide, we'll create a Vercel NextJS app that uses Portkey to route to **200+ LLMs** and makes the app **robust** & **reliable** with full-stack observability, automatic fallbacks, and more."
---
...
<Frame caption="rolling logs and cachescreents">
  <img src="/images/libraries/libraries-6.gif"/>
</Frame>
...
<Frame caption="verel app prompt">
  <img src="/images/libraries/libraries-7.png"/>
</Frame>
