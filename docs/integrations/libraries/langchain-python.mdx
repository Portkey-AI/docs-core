...
<Info>
    This guide covers the integration for the **Python** flavour of Langchain. Docs for the JS Langchain integration are [here](/docs/integrations/libraries/langchain-js).
</Info>
