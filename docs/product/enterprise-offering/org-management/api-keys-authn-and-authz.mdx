...
Portkey uses two types of API keys to manage access to resources and operations: **Admin API Keys** and **Workspace API Keys**. These keys play crucial roles in authenticating and authorizing various operations within your [organization](/docs/product/enterprise-offering/org-management/organizations) and [workspaces](/docs/portkey-endpoints/admin/workspaces).
