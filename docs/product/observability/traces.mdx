...
You can enable tracing by passing the `trace tree` values in your [Portkey metadata](/docs/product/observability/metadata) while making your request (or while instantiating your client).
...
curl https://api.portkey.ai/v1/chat/completions \
  ...
  -H "x-portkey-metadata: {\"traceId\":\"1729\",\"spanId\":\"11\",\"spanName\":\"LLM Call\"}" \
  -d '{
    "model": "gpt-4o",
