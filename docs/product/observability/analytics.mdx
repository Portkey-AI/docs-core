...
<Frame caption="Analytics Overview Dashboard">
  <src img="/images/product/product-12-1.png"/>
</Frame>

## Charts

The dashboard provides insights into your [users](/docs/product/observability/analytics#users), [errors](/docs/product/observability/analytics#errors), [cache](/docs/product/observability/analytics#cache), [feedback](/docs/product/observability/analytics#feedback) and also summarizes information by [metadata](/docs/product/observability/analytics#metadata-summary).
...
The users tab provides an overview of the user information associated with your Portkey requests. This data is derived from the `user` parameter in OpenAI SDK requests or the special `_user` key in the Portkey [metadata header](/docs/product/observability/metadata).
...
<Frame>
  <src img="/images/product/product-12-2.avif"/>
</Frame>
### Errors
...
<Frame caption="Error Analytics Dashboard">
  <src img="/images/product/product-12-3.png"/>
</Frame>
...
<Frame caption="Metadata Analytics">
  <src img="/images/product/product-12-4.png"/>
</Frame>
