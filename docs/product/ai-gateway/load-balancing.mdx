...
### You can [create](/docs/product/ai-gateway/configs#creating-configs) and then [use](/docs/product/ai-gateway/configs#using-configs) the config in your requests.
