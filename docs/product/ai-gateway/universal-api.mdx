...
When using `**custom_host**`, include the version identifier (e.g., `**/v1**`) in the URL. Portkey will append the actual endpoint path (`**/chat/completions**`, `**/completions**`, or `**/embeddings**`) automatically. (For Ollama models, this works differently. [Check here](/docs/integrations/llms/ollama))
</Info>
...
[Multimodal Capabilities](/docs/product/ai-gateway/multimodal-capabilities)
