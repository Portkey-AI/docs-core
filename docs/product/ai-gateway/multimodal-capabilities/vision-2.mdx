...
description: "Portkey's AI gateway currently supports text-to-speech models like `tts-1` and `tts-1-hd` by OpenAI."
---
...
The following providers are supported for text-to-speech with more providers getting added soon. Please raise a [request](/docs/integrations/llms/suggest-a-new-integration) or a [PR](https://github.com/Portkey-AI/gateway/pulls) to add model or provider to the AI gateway.

| Provider                                 | Models         |
| ---------------------------------------- | -------------- |
| [OpenAI](/docs/integrations/llms/openai) | tts-1 tts-1-hd |
