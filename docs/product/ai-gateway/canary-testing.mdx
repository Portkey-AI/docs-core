...
This uses the same techniques as [load balancing](/docs/product/ai-gateway/load-balancing) but to achieve a different outcome.
...
You can now [use this config like this](/docs/product/ai-gateway/configs#using-configs) in your requests.

Once data starts flowing in, we can use Portkey's [analytics dashboards](/docs/product/observability/analytics) to see the impact of the new model on cost, latency, errors and feedback.
