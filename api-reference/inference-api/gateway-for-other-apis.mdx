---
title: "Gateway for Other API Endpoints"
description: The LLM providers you're using might support other endpoints than the one's supported by Portkey. The gateway supports directly proxying the requests for them.
---
...
`**portkey.post(url, requestParams)**`
