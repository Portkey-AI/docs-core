...
<AccordionGroup>
  <Accordion title="Single Provider with Provider Slug (Recommended)">
    ```json
    {
      "provider": "@openai-prod"
    }
  ...
  <Accordion title="Provider Slug with Model & Hyperparameters">
    ```json
    {
  ...
  <Accordion title="Provider Slug with Cache and Retry">
    ```json
    {
      "provider": "@openai-prod",
      "cache": {
  ...
  <Accordion title="Load Balancing with Provider Slugs">
    ```json
    {
      "strategy": {
        "mode": "loadbalance"
  ...
  <Accordion title="Fallback Across Providers">
    ```json
    {
      "strategy": {
        "mode": "fallback"
  ...
  <Accordion title="Legacy: Single Provider with API Key">
    ```json
    {
      "provider": "openai",
      "api_key": "sk-***"
  ...
  <Accordion title="Legacy: Single Provider with Virtual Key">
    ```json
    {
      "virtual_key": "***"
    }
