...
<div className="next-steps-grid">
  <Card title="Add More Providers" icon="plus-circle" href="/integrations/llms">
    Connect Claude, Gemini, Llama, and 1600+ models
  </Card>
  <Card title="Set Up Fallbacks" icon="shield-alt" href="/product/ai-gateway/fallbacks">
    Add redundancy with automatic provider failover
  </Card>
  <Card title="Configure Caching" icon="lightning" href="/product/ai-gateway/cache-simple-and-semantic">
    Reduce costs by 40% with semantic caching
  </Card>
  <Card title="Production Checklist" icon="clipboard-list" href="/self-hosting/hybrid-deployments/architecture">
...
## 💬 Get Help Fast
  ...
  <Card title="Support Portal" icon="ticket" href="https://support.portkey.ai/forms/customer-portal-ticket-form">
    Submit a ticket
