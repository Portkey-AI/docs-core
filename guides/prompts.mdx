...
<Card title="Automated Prompt Replication" href="/guides/prompts/automated-prompt-replication" img="/images/guides/prompts/prompt-image.png">
    Bulk-copy prompts and switch models using the Admin API—Python and Node.js examples for list, retrieve, and create.
</Card>
