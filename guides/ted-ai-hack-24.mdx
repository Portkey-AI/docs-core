...
2. DM your team name, and Vrushank will share your credit details with you - we're sharing 1 Portkey API key with 1 provider of your choosing
3. Browse our [integration docs](/integrations/llms) to learn how easy it is to call any LLM using Portkey — we route to 1,600+ LLMs, all using the common OpenAI API schema
