...
[![](/images/guides/colab-badge.svg)](https://colab.research.google.com/drive/1S5Jb2tTOSbE0ZMSRJ5-z3ks1T11AnmxZ?usp=sharing)
...
portkey = Portkey(
    api_key=userdata.get('PORTKEY_API_KEY'),  # replace with your Portkey API key
    provider="@together-1c20e9"  # replace with your provider slug for Together AI
)
