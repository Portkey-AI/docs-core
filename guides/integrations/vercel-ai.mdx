...
2. Update the provider slug while instantiating your Portkey client
...
```json
{
    ...
    "targets": [
        { "provider": "@openai-virtual-key", "weight": 1 },
        { "provider": "@azure-virtual-key-1", "weight": 1 },
        { "provider": "@azure-virtual-key-2", "weight": 1 }
    ]
}
```
