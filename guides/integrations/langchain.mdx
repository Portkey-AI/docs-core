...
[![](/images/guides/colab-badge.svg)](https://colab.research.google.com/drive/1-EETdhw2RrOCrsmHZP6P7LzSDMsvsJeu?usp=sharing)
...
config = {
    ...
    "targets": [{
        "provider": "@gpt3-8070a6",  # OpenAI's virtual key
        "override_params": {"model": "gpt-3.5-turbo"},
        "weight": 0.5
    }, {
        "provider": "@together-1c20e9",  # Together's virtual key
