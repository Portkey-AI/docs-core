...
<Note>
    Portkey supports parallel tool calling for models that provide it. This allows the model to trigger multiple functions in a single request. See the [parallel function calling guide](/product/ai-gateway/multimodal-capabilities/parallel-function-calling).
</Note>
