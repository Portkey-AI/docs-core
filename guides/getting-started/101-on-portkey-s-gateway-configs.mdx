---
title: "101 on Portkey's Gateway Configs"
description: "You are likely familiar with how to make an API call to GPT4 for chat completions. "
---
...
```javascript Axios icon="square-js"
...
const openai = new OpenAI({
    apiKey: 'X',  // Not used when config is provided
  baseURL: PORTKEY_GATEWAY_URL,
  defaultHeaders: createHeaders({
    apiKey: PORTKEY_API_KEY,
    config: {
