...
```
  ...
  <Tab title="cURL">
    ...
    * [Add the relevant headers](/api-reference/sdk#rest-headers) to enable the AI gateway features.
  </Tab>
  <Tab title="Other SDKs">
    ...
    2. [Add the relevant headers](/api-reference/sdk#rest-headers) to enable the AI gateway features.
  </Tab>
</Tabs>
