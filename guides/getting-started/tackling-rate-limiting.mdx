...
You can read more on [fallbacks here](/docs/product/ai-gateway/fallbacks), and on [loadbalance here](/docs/product/ai-gateway/load-balancing). If you want a deep dive on how Configs work on Portkey, [check out the docs here](/docs/product/ai-gateway/configs).
