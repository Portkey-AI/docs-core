...
top_10_models = [
    ...
    # ["gemini-advanced-0514","google"],           # Not available on public API
    ["gpt-4-turbo-2024-04-09", "openai"],
    ["gpt-4-1106-preview", "openai"],
    ["claude-3-opus-20240229", "anthropic"],
    ["gpt-4-0125-preview", "openai"],
    # ["yi-large-preview","01-ai"],                # Not available on public API
    ...
    ["gpt-4-0314", "openai"],
    ["glm-4", "zhipu"]
    # ["qwen-max-0428","qwen"]                     # Not available outside of China
]
```
...
```python
# Replace the provider slugs below with your own
virtual_keys = {
