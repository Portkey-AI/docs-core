...
<Frame>
  <img src="/images/product/Guardrails/pii-guardrails-logs.png" alt="Shows the transformation view in Portkey logs" />
</Frame>
...
For support, reach out to [Portkey support](https://support.portkey.ai/forms/customer-portal-ticket-form).
